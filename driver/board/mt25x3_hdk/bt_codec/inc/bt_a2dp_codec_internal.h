...
#define DSP_SBC_DEC_DM_PCM_BASE_ADDR    DSP_DM_ADDR(5, 0x1000)
#define DSP_SBC_DEC_DM_PCM_WORD_COUNT   4096

#if defined(__BT_A2DP_CODEC_AWS_SUPPORT__)
#define DSP_CLK_SKEW_PM_PCM_BASE_ADDR    DSP_PM_ADDR(3, 0x3C00)
#define DSP_CLK_SKEW_PM_PCM_WORD_COUNT   0xC0
