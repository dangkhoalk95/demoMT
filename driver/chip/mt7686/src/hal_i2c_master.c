...
volatile static uint8_t i2c_dma_callback_count[HAL_I2C_MASTER_MAX] = {0, 0};
...
static sleep_management_lock_request_t i2c_lock_sleep_handle[HAL_I2C_MASTER_MAX] = {SLEEP_LOCK_I2C0, SLEEP_LOCK_I2C1};
