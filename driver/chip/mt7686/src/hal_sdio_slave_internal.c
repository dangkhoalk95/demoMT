...
void sdio_slave_isr(hal_nvic_irq_t irq_number)
{
    ...
    interrupt_status.sw_interrupte_status_mask = ((uint16_t)((temp_status & (uint32_t)HWFIER_H2D_SW_INT_EN_MASK) >> HWFISR_H2D_SW_INT_OFFSET)) &
...
sdio_slave_status_t sdio_slave_interrupt_status_polling(void)
{
    ...
    interrupt_status.sw_interrupte_status_mask = ((uint16_t)(interrupt_status.sw_interrupte_status_mask & 0xffff)) & sdio_private.sdio_isr_mask.sw_interrupte_enable_mask;
