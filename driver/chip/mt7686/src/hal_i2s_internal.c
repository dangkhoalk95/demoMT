...
void i2s_xpll_open(i2s_internal_t *hal_i2s)
{
    if ((hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XO_26M)) {
        log_hal_info("[I2S%d]XTAL mode\r\n", hal_i2s->i2s_port);
        return;
    }

    log_hal_info("[I2S%d] XPLL mode\r\n", hal_i2s->i2s_port);
    if (bl_xpll_open) {
        log_hal_info("[I2S%d]i2s_xpll is already opened\r\n", hal_i2s->i2s_port);
        return;
    }
    ...
    if (ref_clk == 1) { //26mhz
        if (hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XPLL_26M) {
            log_hal_info("[I2S%d] ref_clk 26M, HAL_I2S_CLOCK_XPLL_26M\r\n", hal_i2s->i2s_port);
        ...
        if (hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XPLL_24_576M) {
            log_hal_info("[I2S%d] ref_clk 26M, HAL_I2S_CLOCK_XPLL_24_576M\r\n", hal_i2s->i2s_port);
        ...
        if (hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XPLL_22_5792M) {
            log_hal_info("[I2S%d] ref_clk 26M, HAL_I2S_CLOCK_XPLL_22_5792M\r\n", hal_i2s->i2s_port);
        ...
        if (hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XPLL_26M) {
            log_hal_info("[I2S%d]ref_clk 40M, HAL_I2S_CLOCK_XPLL_26M\r\n", hal_i2s->i2s_port);
        ...
        if (hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XPLL_24_576M) {
            log_hal_info("[I2S%d]ref_clk 40M, HAL_I2S_CLOCK_XPLL_24_576M\r\n", hal_i2s->i2s_port);
        ...
        if (hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XPLL_22_5792M) {
            log_hal_info("[I2S%d]ref_clk 40M, HAL_I2S_CLOCK_XPLL_22_5792M\r\n", hal_i2s->i2s_port);
...
hal_i2s_status_t i2s_set_clock(i2s_internal_t *hal_i2s, hal_i2s_sample_rate_t sample_rate)
{
    ...
    if (hal_i2s->i2s_port == HAL_I2S_0) {
        ...
        hal_i2s->i2s_clock_source = HAL_I2S_CLOCK_XO_26M;
        log_hal_info("[I2S_1]HAL_I2S_CLOCK_XO_26M\r\n");
#else
        if (fs_base == HAL_I2S_FS_BASE_8KHZ) {
            i2s1_global_cg = (uint32_t)0x00040028;
            hal_i2s->i2s_clock_source = HAL_I2S_CLOCK_XPLL_24_576M;
            log_hal_info("[I2S_1]HAL_I2S_CLOCK_XPLL_24_576M\r\n");
        } else { //HAL_I2S_FS_BASE_11_025KHZ
            i2s1_global_cg = (uint32_t)0x10040028;
            hal_i2s->i2s_clock_source = HAL_I2S_CLOCK_XPLL_22_5792M;
            log_hal_info("[I2S_1]HAL_I2S_CLOCK_XPLL_22_5792M\r\n");
        }
#endif
    }
