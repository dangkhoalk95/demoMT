...
static void internal_pmu_audio_unlock_voltage(void);
#endif
...
static pmu_wrap_api_t pmu_wrap_api = {
    ...
    internal_pmu_audio_unlock_voltage,  /* 10.MT2523 internal pmu Audio unlock Vcore voltage before Deep Sleep function  */
...
static void internal_pmu_audio_lock_voltage(void)
{
    pmu_set_vcore_voltage(PMIC_VCORE_LOCK,PMIC_VOL_1P1V);
    PMIC_VCORE_VOSEL_CONFIG(PMIC_PSI_S1, PMIC_VCORE_0P9V);
}

static void internal_pmu_audio_unlock_voltage(void)
{
    pmu_set_vcore_voltage(PMIC_VCORE_UNLOCK,PMIC_VOL_1P1V);
    PMIC_VCORE_VOSEL_CONFIG(PMIC_PSI_S1, PMIC_VCORE_0P7V);
}
#endif
