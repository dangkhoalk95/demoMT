...
hal_gpio_pin_t g_uart_port_to_txpin[HAL_UART_MAX];
uint8_t g_uart_port_to_txpinmux[HAL_UART_MAX];
uint8_t g_uart_port_to_gpio = 0;

void uart_pin_init_config(hal_uart_port_t uart_port)
{

    switch (uart_port) {
        case HAL_UART_0:
            g_uart_port_to_txpin[0] = HAL_GPIO_17;
            g_uart_port_to_txpinmux[0] = HAL_GPIO_17_U0TXD;
            break;
        case HAL_UART_1:
            /*GPIO5 Mode6
              GPIO22 Mode2
              GPIO31 Mode4
              */
            if (HAL_GPIO_5_U1TXD == ((*(volatile uint32_t *)U1TXD_GPIO5_MODE_ADDRESS & U1TXD_GPIO5_MODE_MASK) >> U1TXD_GPIO5_MODE_SHIFT)) {
                g_uart_port_to_txpin[1] = HAL_GPIO_5;
                g_uart_port_to_txpinmux[1] = HAL_GPIO_5_U1TXD;
            } else if (HAL_GPIO_22_U1TXD == ((*(volatile uint32_t *)U1TXD_GPIO22_MODE_ADDRESS & U1TXD_GPIO22_MODE_MASK) >> U1TXD_GPIO22_MODE_SHIFT)) {
                g_uart_port_to_txpin[1] = HAL_GPIO_22;
                g_uart_port_to_txpinmux[1] = HAL_GPIO_22_U1TXD;
            } else {
                g_uart_port_to_txpin[1] = HAL_GPIO_31;
                g_uart_port_to_txpinmux[1] = HAL_GPIO_31_U1TXD;
            }
            break;
        case HAL_UART_2:
            /* GPIO1 Mode3
               GPIO7 Mode4
               */
            if (HAL_GPIO_1_U2TXD == ((*(volatile uint32_t *)U2TXD_GPIO1_MODE_ADDRESS & U2TXD_GPIO1_MODE_MASK) >> U2TXD_GPIO1_MODE_SHIFT)) {
                g_uart_port_to_txpin[2] = HAL_GPIO_1;
                g_uart_port_to_txpinmux[2] = HAL_GPIO_1_U2TXD;
            } else {
                g_uart_port_to_txpin[2] = HAL_GPIO_7;
                g_uart_port_to_txpinmux[2] = HAL_GPIO_7_U2TXD;
            }
            break;
        case HAL_UART_3:
            /* GPIO3 Mode3
               GPIO22 Mode3
            */
            if (HAL_GPIO_3_U3TXD == ((*(volatile uint32_t *)U3TXD_GPIO3_MODE_ADDRESS & U3TXD_GPIO3_MODE_MASK) >> U3TXD_GPIO3_MODE_SHIFT)) {
                g_uart_port_to_txpin[3] = HAL_GPIO_3;
                g_uart_port_to_txpinmux[3] = HAL_GPIO_3_U3TXD;
            } else {
                g_uart_port_to_txpin[3] = HAL_GPIO_22;
                g_uart_port_to_txpinmux[3] = HAL_GPIO_22_U3TXD;
            }
            break;
        default:
            break;
...
void uart_dte_init_config(uart_dte_config_t *uart_dte_config)
{
    ...
    uart_dte_config[HAL_UART_3].dsr_pin = (hal_gpio_pin_t)HAL_UART3_DTE_DSR_PIN;
    uart_dte_config[HAL_UART_3].dcd_pin = (hal_gpio_pin_t)HAL_UART3_DTE_DCD_PIN;
    uart_dte_config[HAL_UART_3].dtr_pin = (hal_gpio_pin_t)HAL_UART3_DTE_DTR_PIN;
    uart_dte_config[HAL_UART_3].ri_pin = (hal_gpio_pin_t)HAL_UART3_DTE_RI_PIN;
    uart_dte_config[HAL_UART_3].dsr_eint = (hal_eint_number_t)HAL_UART3_DTE_DSR_EINT;
    uart_dte_config[HAL_UART_3].ri_eint = (hal_eint_number_t)HAL_UART3_DTE_RI_EINT;
    uart_dte_config[HAL_UART_3].dcd_eint = (hal_eint_number_t)HAL_UART3_DTE_DCD_EINT;
