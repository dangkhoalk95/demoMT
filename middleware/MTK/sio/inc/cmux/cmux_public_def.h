...
#ifndef __CMUX_PUBLIC_DEF_H__
#define __CMUX_PUBLIC_DEF_H__

#define CMUX_CONTROL_CHANNEL    0x00    // CMUX control channel
#define CMUX_URC_CHANNEL        0x01    // URC channel
#define CMUX_AT_CHANNEL         0x02    // AT command channel
#define CMUX_IP_CHANNEL         0x03    // IP data channel
