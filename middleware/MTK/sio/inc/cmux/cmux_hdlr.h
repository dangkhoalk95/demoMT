...
#ifndef __CMUX_HDLR_H__
#define __CMUX_HDLR_H__
...
extern void cmux_handleUartDataInd(kal_uint8 *pPdu, kal_uint16 u2Length);
extern void cmux_handleCmuxUartCloseDownCnf(void);
extern void cmux_handleTimerExpiry(TimerHandle_t xTimer);
extern bool cmux_handleUartPlugoutInd(void);

#endif /* __CMUX_HDLR_H__ */
