...
#if (MT7682_WSAP00069512==1) 
extern void xEventGroupSetBits_FC();
#if(MT7682_WSAP00069397==1)
extern UCHAR g_PSE_AC3_Enable;
extern void Send_FlowControlEvent(void);
#endif
#endif
...
#if (MT7682_WSAP00069512==1)
#if(MT7682_WSAP00069397==1)
		   if(g_PSE_AC3_Enable==1)
#endif
		   {
		   	xEventGroupSetBits_FC();
#if(MT7682_WSAP00069397==1)
			Send_FlowControlEvent();
#endif
		   }
#endif
        }
