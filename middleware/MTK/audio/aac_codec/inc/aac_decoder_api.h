 ...
 *
 * The AAC decoder is used for AAC-LC format depending on the MTK_AUDIO_AAC_DECODER_ENABLED compiler option.
 *
 ...
 * @return    Media handle of the AAC decoder. Please refer to #aac_decoder_api_media_handle_t.
