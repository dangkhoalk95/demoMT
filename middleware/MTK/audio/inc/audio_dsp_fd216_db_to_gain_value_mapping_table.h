...
#define AUDIO_DOWNLINK_AMP_DB_MINIMUM -73
#define AUDIO_DOWNLINK_AMP_DB_MAXIMUM -5
#define ADUIO_DOWNLINK_AMP_DB_STEP 1
#define VOICE_DOWNLINK_AMP_DB_MINIMUM -51
#define VOICE_DOWNLINK_AMP_DB_MAXIMUM 7
#define VOICE_DOWNLINK_AMP_DB_STEP 1
