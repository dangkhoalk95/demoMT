...
typedef enum {
    ...
    AMR_DECODER_MEDIA_EVENT_END                     /**< Complete data flush. */
...
typedef struct _amr_decoder_handle_t {
    ...
    amr_decoder_status_t (*decoder_flush)(struct _amr_decoder_handle_t *handle, int32_t flush_data_flag); /**< Flush data. */
