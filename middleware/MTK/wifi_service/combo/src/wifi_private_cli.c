...
uint8_t wifi_config_get_rssi_threshold_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_inband_get_rssi_threshold: ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_set_rssi_threshold_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_inband_set_rssi_threshold: ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
uint8_t wifi_config_set_frame_filter_ex(uint8_t len, char *param[])
{
    ...
    if (2 == len) {
        ret = wifi_config_set_frame_filter(enable, BIT(frame_type), NULL);
    }
    else {
        ...
        ret = wifi_config_set_frame_filter(enable, BIT(frame_type), &vender_ie);
    }
    if (ret < 0) {
        status = 1;
    }
    printf("wifi_config_set_frame_filter: ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
uint8_t wifi_config_set_frame_filter_advanced_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_frame_filter_advanced: ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
uint8_t wifi_config_set_n9_dbg_level(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_n9_dbg_level, level = %d, ret:%s, Code=%d\n", dbg_level, WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_get_n9_dbg_level(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_get_n9_dbg_level, level = %d, ret:%s, Code=%d\n",
           dbg_level, WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_connect_scan_ex(uint8_t len, char *param[])
{
    ...
    if( len < 1 ){
        printf("Usage: wifi connect set scan_adv <start/stop> <scan_mode> <scan_option> [chanel_string_2g] [chanel_string_5g] [ssid] [bssid] \n");
        return 1;
    }
    ...
    printf("wifi_connect_scan_ex(), ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_get_tx_power_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_get_tx_power_ex tx_power:%d, ret:%s, Code=%d\n", tx_power, WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_set_tx_power_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_tx_power_ex tx_power:%d, ret:%s, Code=%d\n", tx_power, WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_get_scan_list_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_get_scan_list_ex, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
//    printf("    PHY RATE      = %d \n", mode);
    ...
    printf("wifi_config_get_connection_status_ex(), ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
//    if( 1==link )
    ...
    printf("\n wifi_config_get_statistic_ex, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
...
uint8_t wifi_config_set_ip_filter_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_ip_filter_ex, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
uint8_t wifi_config_set_ip_mac_port_filter_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_ip_mac_port_filter_ex(onoff=%d), ret:%s, Code=%d\n", flag, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
uint8_t wifi_config_get_ip_mac_port_filter_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_get_ip_mac_port_filter_ex(onoff=%d), ret:%s, Code=%d\n", (int)flag, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
uint8_t wifi_config_set_ip_mac_port_entry_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_ip_mac_port_entry_ex(action=%d), ret:%s, Code=%d\n", action, WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_get_ip_mac_port_entry_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_get_ip_mac_port_entry_ex, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
uint8_t wifi_tx_raw_pkt_advanced_ex(uint8_t len, char *param[])
{
    ...
    printf("tx advanced raw packet, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    os_free(hex_buf);
    return status;
}
...
uint8_t wifi_config_set_ps_mode_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_ps_mode_ex ps_power:%d, ret:%s, Code=%d\n", ps_mode, WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_get_ps_mode_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_inband_get_ps_mode ps_power:%d, ret:%s, Code=%d\n", ps_power, WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_calculate_pmk_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_calculate_pmk_ex: ret:%s, Code=%d, key dump:\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
static uint8_t wifi_config_set_scan_tab_size_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_scan_tab_size, size:%d, ret:%s, Code=%d\n", size, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
...
static uint8_t wifi_config_get_scan_tab_size_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_get_scan_tab_size size:%d, ret:%s, Code=%d\n", size, WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
}
#endif
#endif
...
cli_end:
    ...
    printf("wifi_config_set_single_sku_table_ex, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_get_antenna_status_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_get_antenna_status_ex, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_set_antenna_monitor_ex(uint8_t len, char *param[])
{
    ...
    printf("wifi_config_set_antenna_monitor_ex, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
...
uint8_t wifi_config_set_dwell_time_ex(uint8_t len, char *param[])
{
    uint8_t status = 0;
    int32_t ret = 0;
    uint8_t scan_option = atoi(param[0]);
    uint8_t dwell_time = atoi(param[1]);

    ret = wifi_config_set_dwell_time(scan_option, dwell_time);

    if(ret < 0) {
        status = 1;
        printf("set dwell time fail.\r\n");
        return status;
    }

    printf("wifi_config_set_dwell_time_ex scan_mode: %d, dwell_time: %d\r\n", scan_option, dwell_time);
...
uint8_t wifi_config_get_dwell_time_ex(uint8_t len, char *param[])
{
    ...
    ret = wifi_config_get_dwell_time((uint8_t *)&scan_option, (uint8_t *)&dwell_time);

    if(ret < 0) {
        status = 1;
        printf("get parameters fail!\r\n");
        return status;
    }

    printf("get dwell_time: %d\r\n", dwell_time);
...
uint8_t n9log_state_set_cli(uint8_t len, char *param[])
{
    ...
    printf("n9log_state_set_cli, ret:%s, Code=%d\n", WIFI_CLI_RETURN_STRING(ret), (int)ret);
    return status;
#else
    return 0;
#endif
...
cmd_t   wifi_config_set_private_cli[] = {
    ...
    { "dwell_time",     "dwell_time",           wifi_config_set_dwell_time_ex},
...
cmd_t   wifi_config_get_private_cli[] = {
    ...
    { "dwell_time",     "dwell_time",           wifi_config_get_dwell_time_ex},
