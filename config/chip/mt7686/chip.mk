...
## Dependency:  N/A
##
ifeq ($(MT7686_E2_ENABLE),y)
MTK_ROM_VER = e2
COM_CFLAGS         += -DMTK_ROM_VER=e2
COM_CFLAGS         += -DMT7686_E2_ENABLE
...
##              include the libwifi.a libwifi_7686_ram.a
## Path:        middleware/MTK/wifi_stack/src
## Dependency:  libwifi libwifi_7686_ram
## Related doc: Please refer to wifi dev guide under the doc folder for more detail.
##
...
## Dependency:  MTK_MINICLI_ENABLE must also defined in feature.mk in your project\A3\AC
...
## Realted doc:  pls refer to middleware/MTK/homekit/doc/Homekit_Developer_Guide about how to start homekit
##
...
##
## MTK_HOMEKIT_ICLOUD
## Brief:       This option is to enable homekit iCloud under middleware/MTK/homekit folder.
## Usage:       If the value is "y", the MTK_HOMEKIT_ENABLE compile option will be defined, the sources and header files under middleware/MTK/homekit/inc.
## Path:        /middleware/MTK/homekit
## Dependency:  MTK_HOMEKIT_ENABLE, more dependency for lower module be defined in middleware/MTK/homekit/readme.txt.
## Notice:      middleware/MTK/homekit is only for SLA customer with MFi license
## Realted doc:  pls refer to middleware/MTK/homekit/doc/Homekit_Developer_Guide about how to start homekit
##
...
##              middleware/MTK/homekit/src/profile/customized/mtk_template/helper/mock be included by middleware/MTK/homekit/src/module.mk.
## Path:        /middleware/MTK/homekit/src/profile/customized
...
##
## MTK_WIFI_PTA_ENABLE
## Brief:  Enable Wi-Fi PTA API.
## Usage:  If the value is "y", the MTK_WIFI_PTA_ENABLE compile option will be defined.
## Path:   N/A
## Dependency:  N/A
##
ifeq ($(MTK_WIFI_PTA_ENABLE),y)
COM_CFLAGS         += -DMTK_WIFI_PTA_ENABLE
endif


##
## MTK_WIFI_PTA_CLI_ENABLE
## Brief:  Enable Wi-Fi PTA CLI commands.
## Usage:  If the value is "y", the MTK_WIFI_PTA_CLI_ENABLE compile option will be defined.
## Path:   N/A
## Dependency:  N/A
##
ifeq ($(MTK_WIFI_PTA_CLI_ENABLE),y)
COM_CFLAGS         += -DMTK_WIFI_PTA_CLI_ENABLE
endif
...
##              You must also include the gva/middleware/MTK/audio/module.mk, gva/middleware/third_party/fatfs/module.mk and gva/middleware/MTK/audio/amr_codec/lib/arm_cm4/libamr.a in your Make    file before setting the option to "y".
...
## Usage:       Enable the feature by configuring it as y.
## Path:        project/mt7686_hdk/apps/iot_sdk_demo/src/sys_init.c, middleware/MTK/connsys/src/connsys_util.c
## Dependency:  None
## Notice:      None
## Relative doc:None
##
...
DRV_BSP_PATH 		= $(SOURCE_DIR)/driver/board/mt7686_hdk
