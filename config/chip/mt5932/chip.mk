...
## Dependency:  N/A
##
ifeq ($(MT5932_E2_ENABLE),y)
MTK_ROM_VER = e2
COM_CFLAGS         += -DMTK_ROM_VER=e2
COM_CFLAGS         += -DMT5932_E2_ENABLE
...
##
## MTK_WIFI_SLIM_ENABLE
## Brief:  Enable Wi-Fi firmware download in early stage to maximize BSS space.
## Usage:  If the value is "y", the MTK_WIFI_SLIM_ENABLE compile option will be defined.
## Path:   N/A
## Dependency:  N/A
##
ifeq ($(MTK_WIFI_SLIM_ENABLE),y)
COM_CFLAGS         += -DMTK_WIFI_SLIM_ENABLE
endif
...
##              You must also include the gva/middleware/MTK/audio/module.mk, gva/middleware/third_party/fatfs/module.mk and gva/middleware/MTK/audio/mp3_codec/lib/arm_cm4/libmp3dec.a in your Make    file before setting the option to "y".
...
##
## MTK_I2S_ENABLED
## Brief:       This option is temp used and it is to enable mp3 playback with I2S.
##
...
##
## MTK_AUDIO_I2S_REC_ENABLED
## Brief:       This option is temp used and it is to enable voice record demo with I2S.
##
ifeq ($(MTK_AUDIO_I2S_REC_ENABLED), y)
CFLAGS += -DMTK_AUDIO_I2S_REC_ENABLED
endif

##
## MTK_AUDIO_SPEEX_ENABLED
## Brief:       This option is temp used and it is to enable speex codec demo with I2S.
##
ifeq ($(MTK_AUDIO_SPEEX_ENABLED), y)
CFLAGS += -DMTK_AUDIO_SPEEX_ENABLED
endif
...
## Brief:       This option is to enable external 32K for low power .
## Usage:       Enable the feature by configuring it as y.
## Path:
## Dependency:  None
## Notice:      None
...
## Brief:       This option is to enable WFC for MT5932.
## Usage:       Enable the feature by configuring it as y.
## Path:	middleware/MTK/wifi_service/wfc
##		middleware/MTK/wifi_service/bwcs
## Dependency:  IC_CONFIG = mt5932
## Notice:      This feature option used for MT5932 only.
## Relative doc:None
##
ifeq ($(MTK_WIFI_STUB_CONF_ENABLE),y)
COM_CFLAGS         += -DMTK_WIFI_STUB_CONF_ENABLE

ifeq ($(MTK_WFC_AT_SLAVE_ENABLE),y)
COM_CFLAGS         += -DMTK_WFC_AT_SLAVE_ENABLE
endif

ifeq ($(MTK_WIFI_STUB_CONF_SPI_ENABLE),y)
COM_CFLAGS         += -DMTK_WIFI_STUB_CONF_SPI_ENABLE
endif

endif

##
## MTK_CLI_EXAMPLE_MODE_ENABLE
## Brief:       This option is to enable CLI for MT5932.
## Usage:       Enable the feature by configuring it as y.
## Path:
## Dependency:  None
## Notice:      None
...
COM_CFLAGS         += -DMTK_CLI_EXAMPLE_MODE_ENABLE
endif
...
ifeq ($(MTK_MT5932_ENABLE),y)
COM_CFLAGS         += -DMTK_MT5932_ENABLE
endif
...
DRV_BSP_PATH 		= $(SOURCE_DIR)/driver/board/mt5932_hdk
