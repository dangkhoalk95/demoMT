...
## Usage:     If the value is "y", the MTK_SYSTEM_AT_COMMAND_ENABLE compile option will be defined. You must also include the gva\kernel\service\module.mk in your Makefile before setting the option to "y". 
## Path:       kernel/service
## Dependency:  None
## Notice:      None
## Relative doc:None
...
#external dsp files
ifeq ($(MTK_EXTERNAL_DSP_ENABLE), y)
  CFLAGS += -DMTK_EXTERNAL_DSP_ENABLE
endif

# Speech NDVC support
ifeq ($(MTK_NDVC_ENABLE), y)
  CFLAGS += -DMTK_NDVC_ENABLE
  export MTK_NDVC_ENABLE=y
endif
...
##              You must also include the gva/middleware/MTK/audio/module.mk, gva/middleware/third_party/fatfs/module.mk and gva/middleware/MTK/audio/mp3_codec/lib/arm_cm4/libmp3dec.a in your Makefile before setting the option to "y".
...
ifeq ($(MTK_BT_AWS_ENABLE), y)
  CFLAGS += -DMTK_AUDIO_MP3_CODEC_AWS_SUPPORT
endif
...
ifeq ($(__BT_ENAMBEL_BA__),y)
  CFLAGS += -D__BT_ENAMBEL_BA__
endif
...
ifeq ($(MTK_EXTERNAL_PMIC_TYPE),MT6327)
  CFLAGS += -DMTK_EXTERNAL_PMIC_TYPE_MT6327
endif
endif
...
MID_BLE_ANCS_PATH       = $(SOURCE_DIR)/middleware/MTK/ble_ancs
