...
##
## MTK_BT_MESH_CLI_ENABLE
## Brief:       This option is to enable/disable the mesh commands.
## Usage:       If the value is "y", the MTK_BT_MESH_CLI_ENABLE will be defined, the related code in the file mesh_cli.c/.h and the file minicli_cmd_table.h will be included.
## Path:        middleware/MTK/mesh/src/, middleware/MTK/mesh/inc/, middleware/MTK/minicli/inc
## Dependency:  MTK_MINICLI_ENABLE
## Notice:      None.
## Relative doc:None.
##
ifeq ($(MTK_BT_MESH_CLI_ENABLE),y)
COM_CFLAGS         += -DMTK_BT_MESH_CLI_ENABLE
endif
