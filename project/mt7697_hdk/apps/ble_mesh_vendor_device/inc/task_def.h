...
/* for mesh gateway demo task */
#define MESH_GATEWAY_TCP_TASK_NAME                   "mesh_gateway_tcp_server"
#define MESH_GATEWAY_TCP_TASK_STACKSIZE              (512 * 4)
#define MESH_GATEWAY_TCP_TASK_PRIO                   TASK_PRIORITY_NORMAL
