...
static const group_data_item_t g_common_data_item_array[] = {
    ...
    NVDM_DATA_ITEM("AntennaNumber",        WIFI_DEFAULT_ANT_NUMBER),
    NVDM_DATA_ITEM("AntDiversityEnable",   WIFI_DEFAULT_ANT_DIVERSITY_ENABLE),
    NVDM_DATA_ITEM("AntProbeReqCount",     WIFI_DEFAULT_ANT_PROB_REQ_COUNT),
    NVDM_DATA_ITEM("AntThresholdRssi",     WIFI_DEFAULT_ANT_THRESHOLD_LEVEL),
    NVDM_DATA_ITEM("AntDeltaRssi",         WIFI_DEFAULT_ANT_DELTA_RSSI),
    NVDM_DATA_ITEM("AntRssiSwitch",        WIFI_DEFAULT_ANT_RSSI_SWITCH),
    NVDM_DATA_ITEM("AntPreSelectedRssi",   WIFI_DEFAULT_ANT_PRE_SELECTED_RSSI),
#endif
};
