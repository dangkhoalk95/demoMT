 ...
 * @{
 * @addtogroup mt7697_hdk_apps_aws_iot aws_iot
 * @{
...
@par Directory contents
  - Source and header files.
    ...
    - \b src/system_mt7697.c:     The configuration file of the Cortex-M4 with
  ...
  - Project configuration files using GCC
    ...
    - \b GCC/mt7697_flash.ld:     Linker script.
    - \b GCC/startup_mt7697.s:    MT76x7's startup file for GCC.
...
@par Run the application
  ...
  - Build the application with the command, "./build.sh mt7697_hdk
