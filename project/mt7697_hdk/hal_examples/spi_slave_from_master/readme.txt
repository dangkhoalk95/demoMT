 ...
 * @{
 * @addtogroup mt7697_hdk_hal_examples_spi_slave_from_master spi_slave_from_master
 * @{

@par Overview
  - Example description
    - This example is a reference application to use SPI Slave API to
      communicate with SPI Master on the LinkIt 7697 HDK.
...
@par Hardware and software environment
  ...
  - HDK switches and pin configuration
    - SPI pin mapping is listed below.
      ...
      |                        |                      |                          |
      |_MT7697_________________|                      |_MT7697___________________|
      \endcode
