...
/**
*@brief  In this function we get current millisecond with unit of millisecond.
*@param None.
*@return return the current time with unit of millisecond.
*/
...
/**
*@brief Set GPT timer type and start GPT with repeat mode.
*@param None.
*@return None.
*/
