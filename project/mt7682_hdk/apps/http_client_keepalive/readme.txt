 ...
 * @{
 * @addtogroup mt7682_hdk_apps_http_client http_client
 * @{
 * @addtogroup mt7682_hdk_apps_http_client_http_client_keepalive http_client_keepalive
 * @{
...
@par Run the application
  - Build the application with a command "./build.sh mt7682_hdk
