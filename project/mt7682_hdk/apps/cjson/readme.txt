 ...
 * @{
 * @addtogroup mt7682_hdk_apps_cjson cjson
 * @{
...
@par Run the application
  - Build the application with the command, "./build.sh mt7682_hdk cjson"
    from the SDK root folder and download the bin file to LinkIt 7682 HDK.
