 ...
 * @{
 * @addtogroup mt7682_hdk_apps_mbedtls mbedtls
 * @{
...
@par Run the application
  - Build the application with the command "./build.sh mt7682_hdk mbedtls"
    from the SDK root folder and download the binary file to the LinkIt 7682
    evelopment board.
