 ...
 * @{
 * @addtogroup mt7682_hdk_apps_xml xml
 * @{
...
@par Run the application
  - Build the application with the command, "./build.sh mt7682_hdk xml" from
    the SDK root folder and download the bin file to LinkIt 7682 HDK.
