...
#ifdef WIFI_DEFAULT_STA_SSID
#undef WIFI_DEFAULT_STA_SSID
#define WIFI_DEFAULT_STA_SSID           "SQA_TEST_AP"
#endif

#ifdef WIFI_DEFAULT_STA_SSID_LEN
#undef WIFI_DEFAULT_STA_SSID_LEN
#define WIFI_DEFAULT_STA_SSID_LEN       "11"
#endif

#ifdef WIFI_DEFAULT_STA_WPA_PSK
#undef WIFI_DEFAULT_STA_WPA_PSK
#define WIFI_DEFAULT_STA_WPA_PSK        "77777777"
#endif

#ifdef WIFI_DEFAULT_STA_WPA_PSK_LEN
#undef WIFI_DEFAULT_STA_WPA_PSK_LEN
