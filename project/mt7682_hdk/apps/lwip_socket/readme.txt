 ...
 * @{
 * @addtogroup mt7682_hdk_apps_lwip_socket lwip_socket
 * @{
...
@par Directory contents
  ...
  - Project configuration files using IAR
    - \b EWARM/lwip_socket.ewd:  IAR project options. Contains the settings for
                                 the debugger.
    - \b EWARM/lwip_socket.ewp:  IAR project file. Contains the project
                                 structure in XML format.
    - \b EWARM/lwip_socket.eww:  IAR workspace file. Contains project
                                 information.
    - \b EWARM/flash.icf:        Linker script.

@par Run the application
  - Build the application with the command, "./build.sh mt7682_hdk
    lwip_socket" from the SDK root folder and download the bin file to LinkIt
    7682 HDK.
