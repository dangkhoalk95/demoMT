 ...
 * @{
 * @addtogroup mt7682_hdk_hal_examples_ept_configure_pins_by_ept ept_configure_pins_by_ept
 * @{
...
@par Directory contents
  - Source and header files
    ...
    - \b src/system_mt7682.c:  MT2523x system clock configuration file.
    ...
    - \b GCC/startup_mt7682.s:  MT2523x startup file for GCC.
...
@par Run the example
  - Copy EPT generated files to the target project folder.
    - Copy ept_gpio_var.c and ept_eint_var.c to
      /project/mt7682_hdk/hal_examples/ept_configure_pins_by_ept/src/.
    - Copy ept_eint_drv.h, ept_gpio_drv.h and ept_keypad_drv.h to
      /project/mt7682_hdk/hal_examples/ept_configure_pins_by_ept/inc/.
    - Call the API bsp_ept_gpio_setting_init() to configure the EPT and
      on-board pins.
  - Build the example project with a command "./build.sh
    mt7682_hdk ept_configure_pins_by_ept bl" from the SDK root
