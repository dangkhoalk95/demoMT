...
#define SPIS_PIN_NUMBER_SIO_2   HAL_GPIO_13
#define SPIS_PIN_FUNC_SIO_2     HAL_GPIO_13_SPISLV_B_SIO2
#define SPIS_PIN_NUMBER_SIO_3   HAL_GPIO_12
#define SPIS_PIN_FUNC_SIO_3     HAL_GPIO_12_SPISLV_B_SIO3
...
*@return None.
*/
static bool spi_slave_transfer_data_two_boards_example(void)
{
    uint32_t i = 0;
    ...
    hal_gpio_deinit(SPIS_PIN_NUMBER_SIO_0);
    hal_gpio_deinit(SPIS_PIN_NUMBER_SIO_1);
    hal_gpio_deinit(SPIS_PIN_NUMBER_SIO_2);
    hal_gpio_deinit(SPIS_PIN_NUMBER_SIO_3);
...
int main(void)
{
    ...
    /* Add your application code here. */
    ret = spi_slave_transfer_data_two_boards_example();
