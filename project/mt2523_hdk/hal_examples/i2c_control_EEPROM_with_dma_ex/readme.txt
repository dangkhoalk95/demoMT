 ...
 * @{
 * @addtogroup mt2523_hdk_hal_examples_i2c_control_EEPROM_with_dma_ex i2c_control_EEPROM_with_dma_ex
 * @{
...
@par Directory contents
  - Source and header files
    ...
    - \b CC/startup_mt2523.s.           MT2523x startup file for GCC.
  ...
  - Project configuration files using Keil IDE
    - \b MDK-ARM/i2c_control_EEPROM_with_dma_ex.uvprojx:
                             uVision5 project file. Contains the project
                             structure in XML format.
    - \b MDK-ARM/i2c_control_EEPROM_with_dma_ex.uvoptx:
...
@par Run the example
  ...
  - Connect J1014 SCL0 and J1014 SDA0 to the SCL(clock) and SDA(data) pins of
    ...
    CON6102 Right.1 and GND of EEPROM with J1018 GND on LinkIt 2523 HDK.
