 ...
 * @{
 * @addtogroup mt7686_hdk_hal_examples_wdt_feed_watchdog wdt_feed_watchdog
 * @{
...
@par Run the example
  - Build the example project with a command "./build.sh mt7686_hdk
    ...
    file to LinkIt 7686 HDK. Then remove the strap pin connector for download
    mode, which name is J2201.
