 ...
 * @{
 * @addtogroup mt7686_hdk_hal_examples_spi_master_to_slave spi_master_to_slave
 * @{

@par Overview
  - Example description
    - This example is a reference application to demonstrate how to use SPI
      master API to communicate with an SPI slave with two LinkIt 7686 HDKs.
  ...
  - Features of the example project
    - The example project has two parts: 1. LinkIt 7686 HDK operates as SPI
      Master device (spi_master_to_slave). 2. LinkIt 7686 HDK operates as SPI
