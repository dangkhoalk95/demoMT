 ...
 * @{
 * @addtogroup mt7686_hdk_hal_examples_aes_encrypt_decrypt_data aes_encrypt_decrypt_data
 * @{
...
@par Run the example
  - Build the example project with the command, "./build.sh mt7686_hdk
    aes_encrypt_decrypt_data" from the SDK root folder and download the bin
    file to LinkIt 7686 development board.
