 ...
 * @{
 * @addtogroup mt7686_hdk_apps_minicli minicli
 * @{
...
@par Directory contents
  ...
  - Project configuration files using GCC
    - \b GCC/startup_mt7686.s:  MT76x7 startup file for GCC.
    - \b GCC/syscalls.c:        The minimal implementation of the system calls.
    - \b GCC/mt7686_hdk.cmm:    This CMM is for lakrpsur development on 7686 E2
                                EVB.
