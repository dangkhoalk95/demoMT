 ...
 * @{
 * @addtogroup mt7686_hdk_apps_cjson cjson
 * @{
...
@par Run the application
  - Build the application with the command, "./build.sh mt7686_hdk cjson"
    from the SDK root folder and download the bin file to LinkIt 7686 HDK.
