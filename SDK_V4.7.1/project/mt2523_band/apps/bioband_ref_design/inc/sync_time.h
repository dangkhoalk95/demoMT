...
#define SYNC_TIME_CMD_HEADER "mtkcare"
#define SYNT_TIME_RESPONSE_LEN 30

typedef enum {
    SYNC_TIME_TAG_ID_TIMESTAMP = 0x01,
    SYNC_TIME_TAG_ID_TIMEZONE
}sync_time_tag_id;

typedef enum {
    SYNC_TIME_STATUS_SUCCESS,
    SYNC_TIME_STATUS_FAIL = -0x01
}sync_time_status;
