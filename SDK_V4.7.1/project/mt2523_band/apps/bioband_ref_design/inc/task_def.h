...
/*This definition determines whether GRAPHIC TASK functions, such as UI/key management/lcd management. If it is not defined, then the demo will have no user interface displayed on LCM.*/
