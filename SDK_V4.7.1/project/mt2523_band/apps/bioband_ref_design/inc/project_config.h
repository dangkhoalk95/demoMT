...
#define BT_TX_BUF_SIZE 90*1024
#define BT_RX_BUF_SIZE 5*1024
...
#define BT_SPP_TOTAL_CONNECTION_NUM  (3) /**<[IMPORTANT!]total num = N1 + N2 + ..., Nx is the really used connection num for link-x, each link may different*/
