...
#define CHARGING_FULL_CURRENT       40     /* mA */

/* Charging Current Setting */
#define USB_CHARGER_CURRENT                 HAL_CHARGE_CURRENT_120_MA       /* 300mA */
#define AC_CHARGER_CURRENT                  HAL_CHARGE_CURRENT_120_MA
#define NON_STD_AC_CHARGER_CURRENT          HAL_CHARGE_CURRENT_120_MA
#define CHARGING_HOST_CHARGER_CURRENT       HAL_CHARGE_CURRENT_120_MA
