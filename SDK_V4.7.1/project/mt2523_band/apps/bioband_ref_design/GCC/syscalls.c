...
/*This definition is used to enable the port service feature. By default, the port service feature is enabled in this project. If user wants to disabled port service feature, he/she can set "MTK_PORT_SERVICE_ENABLE = n" in the feature.mk of GCC folder. Port service feature has one dependency that NVDM module must be enabled.*/
