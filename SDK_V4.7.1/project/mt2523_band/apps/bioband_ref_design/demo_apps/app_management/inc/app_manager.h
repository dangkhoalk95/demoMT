...
typedef void (*appTaskFunc)(void *pParameters);

typedef struct _tAppTask {
    enum tModeType btn1Mode;
    enum tModeType btn2Mode;
    appTaskFunc pAppTask;
} tAppTask;
...
extern QueueHandle_t ui_main_event_queue;
