 ...
 * @{
 * @addtogroup mt7686_hdk_hal_examples_rtc_set_alarm rtc_set_alarm
 * @{

@par Overview
  - Example description
    - This example is a reference application to use RTC API to control the
      RTC module on the MT7686 HDK, including set time, get time, set alarm
