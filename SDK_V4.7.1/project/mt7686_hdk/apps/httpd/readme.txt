 ...
 * @{
 * @addtogroup mt7686_hdk_apps_httpd httpd
 * @{
...
@par Directory contents
  ...
  - Project configuration files using IAR IDE
    ...
    - \b EWARM/web_c/webdata.h:  LinkIt 7686 HDK does not support file system.
                                 The file has to be stored in static memory.
                                 The files are generated by GCC linker in web_c
                                 folder.

@par Run the application
  - Build the application with a command "./build.sh mt7686_hdk httpd" from
    the SDK root folder and download the binary file to LinkIt 7686 HDK.
