 ...
 * @{
 * @addtogroup mt7686_hdk_apps_bootloader bootloader
 * @{

@par Overview
  - This is not an example project. This project is a bootloader for MT7686 HDK.
...
@par Hardware and software environment
  - Environment configuration
    ...
    - Install the mbed serial driver according to the instructions at
      ...
      more information, please refer to section "Installing the MT7686
      HDK drivers on Microsoft Windows" on the "MT7686_HDK_Users_Guide.pdf"
      in [sdk_root]/doc/board/mt7686_hdk folder.
    - Use a type-A to micro-B USB cable to connect type-A USB of the PC and
      MK20 micro-B USB connector on the MT7686 HDK. For more information
...
@par Run the example
  ...
  - Build bootloader and an example project with the command, "./build.sh
    mt7686_hdk example_project_name bl" under the SDK root folder and
    download the binary file to MT7686 HDK.
  - Power on MT7686 HDK and bootloader log are showen on serial tool.
 * @}
 * @}
 * @}
*/
