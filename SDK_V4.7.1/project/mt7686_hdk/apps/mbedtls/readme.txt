 ...
 * @{
 * @addtogroup mt7686_hdk_apps_mbedtls mbedtls
 * @{
...
@par Overview
  - Application description
    - This application consists of some demonstrations for the features
      ...
      client demonstration, and so on. It also demonstrates the case that
      mbedtls module uses hardware algorithms by using feature_hw.mk. For more
      detail of each demonstration, please refer to the descriptions below.
  ...
  - Environment configuration
    - The output logs are communicated through a micro-USB cable to the PC
      ...
      - Use a type-A to micro-B USB cable to connect type-A USB of the PC and
        MK20 micro-B USB connector on the LinkIt 7686 HDK. For more
...
@par Directory contents
  ...
  - Project configuration files using GCC
    ...
    - \b GCC/feature_hw.mk:    Feature configuration for the case that mbedtls
                               module uses hardware algorithms.
...
@par Run the application
  - Build the application with the command "./build.sh mt7686_hdk mbedtls"
    from the SDK root folder and download the binary file to the LinkIt 7686
    evelopment board.
