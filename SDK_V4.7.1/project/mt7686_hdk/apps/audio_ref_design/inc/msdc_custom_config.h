...
*/
#define FS_MSDC_BUS_WIDTH  (1)

/*Define the bus clock, for bus clock,it should be less than 50000, the unit is kHz.*/
#define FS_MSDC_BUS_CLOCK  (48000)   /*Define bus clock to 45MHz.*/
...
/*Define the bus width.
    ...
    2: HAL_SD_BUS_WIDTH_4
*/
#define MASS_STORAGE_MSDC_BUS_WIDTH  (1)

/*Define the bus clock, for bus clock,it should be less than 50000, the unit is kHz.*/
#define MASS_STORAGE_MSDC_BUS_CLOCK  (48000)   /*Define bus clock to 45MHz.*/
