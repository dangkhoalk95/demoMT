 ...
 * @{
 * @addtogroup mt7697_hdk_templates_no_rtos_initialize_system no_rtos_initialize_system
 * @{
...
@par Hardware and software environment
  ...
  - Environment configuration
    ...
    - Install the mbed serial driver according to the instructions at
      ...
      HDK drivers on Microsoft Windows" on the "LinkIt 7697HDK User Guide" in
      [sdk_root]/doc folder.
...
@par Directory contents
  - Source and header files
    ...
    - \b GCC/startup_mt7687.s:  MT76x7 start up file for GCC.
    - \b GCC/syscalls.c:        MT76x7 syscalls for GCC.
    - \b MDK-ARM/startup_mt7687.s:
                                MT76x7 start up file for Keil IDE.
...
@par Run the example
  - Build the project with a command "./build.sh mt7697_hdk
    no_rtos_initialize_system" from the SDK root folder and download the
