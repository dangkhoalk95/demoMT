 ...
 * @{
 * @addtogroup mt7687_hdk_apps_bootloader bootloader
 * @{
...
@par Directory contents
  ...
  - Project configuration files using IAR IDE
    ...
    - \b EWARM/bootloader.eww:     IAR workspace file. Contains project
                                   information.
    - \b EWARM/mtk7687_flash.icf:  Linker script.

@par Run the example
  - Connect board to the PC with serial port cable.
  - Build bootloader with the command, "./build.sh mt7687_hdk bootloader"
    under the SDK root folder and download the binary file to LinkIt 7687
    HDK.
  - Power on LinkIt 7687 HDK and bootloader log are showen on serial tool.
 * @}
 * @}
 * @}
*/
