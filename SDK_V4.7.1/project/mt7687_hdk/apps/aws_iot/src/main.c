...
#include "aws_iot_test.h"

#define WIFI_SSID                ("SQA_TEST_AP")
#define WIFI_PASSWORD            ("77777777")

/**
  * Create the log control block for aws iot.
  * User needs to define their own log control blocks as project needs.
  * Please refer to the log dev guide under /doc folder for more details.
  */
log_create_module(aws_iot_proj, PRINT_LEVEL_INFO);
...
int main(void)
{
    ...
    LOG_I(aws_iot_proj, "FreeRTOS Running \n");
    ...
    /*if (pdPASS != xTaskCreate(user_entry,
                              ...
                              APP_TASK_PRIO,
                              NULL)) {
        LOG_E(aws_iot_proj, "create user task fail");
        return -1;
    }*/
    start_aws_iot_tests();
