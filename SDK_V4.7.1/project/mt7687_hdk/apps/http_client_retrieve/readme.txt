 ...
 * @{
 * @addtogroup mt7687_hdk_apps_http_client_http_client_retrieve http_client_retrieve
 * @{
...
@par Directory contents
  ...
  - Project configuration files using Keil IDE
    - \b MDK-ARM/http_client_retrieve.uvprojx:
                             uVision5 project file. Contains the project
                             structure in XML format.
    - \b MDK-ARM/http_client_retrieve.uvoptx:
...
@par Run the application
  - Build the application with a command "./build.sh mt7687_hdk
    http_client_retrieve" from the SDK root folder and download the binary
