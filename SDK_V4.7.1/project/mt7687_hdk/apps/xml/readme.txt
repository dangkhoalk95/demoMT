 ...
 * @{
 * @addtogroup mt7687_hdk_apps_xml xml
 * @{

@par Overview
  - Application description
    - This application shows the usage of APIs of XML module.
  - Features of the application
    - This application demonstrates how to create an XML string and how to
      parse an XML string.
...
@par Directory contents
  - Source and header files
    ...
    - \b src/xml_test.c:        xml test file.This file was derived from
  ...
  - Project configuration files using Keil
    - \b MDK-ARM/xml.uvprojx:  uVision5 project file. Contains the project
                               structure in XML format.
    - \b MDK-ARM/xml.uvoptx:   uVision5 project options. Contains the settings
                               for the debugger, trace configuration,
                               breakpoints, currently open files, etc.
    - \b MDK-ARM/flash.sct:    Linker script.
  - Project configuration files using IAR
    - \b EWARM/xml.ewd:    IAR project options. Contains the settings for the
                           debugger.
    - \b EWARM/xml.ewp:    IAR project file. Contains the project structure in
                           XML format.
    - \b EWARM/xml.eww:    IAR workspace file. Contains project information.
    - \b EWARM/flash.icf:  Linker script.

@par Run the application
  - Build the application with the command, "./build.sh mt7687_hdk xml" from
    the SDK root folder and download the bin file to LinkIt 7687 HDK.
