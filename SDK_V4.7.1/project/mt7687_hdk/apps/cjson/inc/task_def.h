...
/* for cjson example task*/
#define CJSON_EXAMPLE_TASK_NAME           "cjson_test"
#define CJSON_EXAMPLE_TASK_STACKSIZE      (1024 * 4)
#define CJSON_EXAMPLE_TASK_PRIO           TASK_PRIORITY_NORMAL
