 ...
 * @{
 * @addtogroup mt7687_hdk_apps_cjson cjson
 * @{
...
@par Directory contents
  ...
  - Project configuration files using Keil
    - \b MDK-ARM/cjson.uvprojx:  uVision5 project file. Contains the project
                                 structure in XML format.
    - \b MDK-ARM/cjson.uvoptx:   uVision5 project options. Contains the
                                 settings for the debugger, trace
                                 configuration, breakpoints, currently open
                                 files, etc.
    - \b MDK-ARM/flash.sct:      Linker script.
  - Project configuration files using IAR
    - \b EWARM/cjson.ewd:  IAR project options. Contains the settings for the
                           debugger.
    - \b EWARM/cjson.ewp:  IAR project file. Contains the project structure in
                           XML format.
    - \b EWARM/cjson.eww:  IAR workspace file. Contains project information.
    - \b EWARM/flash.icf:  Linker script.

@par Run the application
  - Build the application with the command, "./build.sh mt7687_hdk cjson"
    from the SDK root folder and download the bin file to LinkIt 7687 HDK.
