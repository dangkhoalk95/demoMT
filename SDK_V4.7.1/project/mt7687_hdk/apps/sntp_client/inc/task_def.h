...
#define APP_TASK_STACKSIZE              (1024 * 2)
#define APP_TASK_PRIO                   TASK_PRIORITY_NORMAL


#define APP_SNTP_TASK_NAME                   "sntpverify"
#define APP_SNTP_TASK_STACKSIZE              (1024 * 4)
#define APP_SNTP_TASK_PRIO                   TASK_PRIORITY_NORMAL
