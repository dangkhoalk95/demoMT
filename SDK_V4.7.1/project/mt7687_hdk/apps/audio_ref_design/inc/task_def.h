...
#define MP3_PLAY_EXAMPLE_TASK_NAME       "mp3_codec_ut"
...
/* for SPEEX CODEC  task */
#define SPEEX_CODEC_TASK_NAME           "SPEEX_CODEC_TASK_NAME"
#define SPEEX_CODEC_TASK_STACKSIZE      1024
#define SPEEX_CODEC_TASK_PRIO           TASK_PRIORITY_SOFT_REALTIME
#define SPEEX_CODEC_TASK_QUEUE_LENGTH   20

/* for SPEEX CODEC  demo  */
#define SPEEX_CODEC_DEMO_NAME           "SPEEX_CODEC_DEMO"
#define SPEEX_CODEC_DEMO_STACKSIZE      1024
#define SPEEX_CODEC_DEMO_PRIO           TASK_PRIORITY_NORMAL
