 ...
 * @{
 * @addtogroup mt7687_hdk_apps_http_client http_client
 * @{
 * @addtogroup mt7687_hdk_apps_http_client_http_client_keepalive http_client_keepalive
 * @{
...
@par Directory contents
  ...
  - Project configuration files using Keil IDE
    - \b MDK-ARM/http_client_keepalive.uvprojx:
                             uVision5 project file. Contains the project
                             structure in XML format.
    - \b MDK-ARM/http_client_keepalive.uvoptx:
  ...
  - Project configuration files using IAR IDE
    - \b EWARM/http_client.ewd:  IAR project options. Contains the settings for
                                 the debugger.
    - \b EWARM/http_client.ewp:  IAR project file. Contains the project
                                 structure in XML format.
    - \b EWARM/http_client.eww:  IAR workspace file. Contains project
                                 information.
    - \b EWARM/flash.icf:        Linker script.

@par Run the application
  - Build the application with a command "./build.sh mt7687_hdk
    http_client_keepalive" from the SDK root folder and download the binary
