 ...
 * @{
 * @addtogroup mt7687_hdk_hal_examples_pwm_generate_waveform pwm_generate_waveform
 * @{

@par Overview
  - Example description
    - This example is a reference application to use the PWM module to
      generate a waveform with fixed frequency (200Hz) and duty cycle ratio
      (50%).
    - This example does not require FreeRTOS.
  - Results
    - The system will log "pwm_example finished!!!" and the generated
      waveform could be observed on an oscilloscope.
...
@par Run the example
  ...
  - Connect J35.6 and J32.6 to oscilloscope channel 1 and corresponding GND.
  ...
  - Run the example. Use oscilloscope to observe the waveform generated by
    PWM. A waveform with 200Hz frequency and 50% duty cycle indicates a
