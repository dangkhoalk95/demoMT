 ...
 * @{
 * @addtogroup mt7687_hdk_hal_examples_wdt_feed_watchdog wdt_feed_watchdog
 * @{
...
@par Directory contents
  ...
  - Project configuration files using Keil IDE
    - \b MDK-ARM/wdt_feed_watchdog.uvprojx:
                             uVision5 project file. Contains the project
                             structure in XML format.
    - \b MDK-ARM/wdt_feed_watchdog.uvoptx:
...
@par Run the example
  - Build the example project with a command "./build.sh mt7687_hdk
    wdt_feed_watchdog" from the SDK root folder and download the binary file
    to LinkIt 7687 HDK.
