 ...
 * @{
 * @addtogroup mt7687_hdk_hal_examples_adc_get_data_polling adc_get_data_polling
 * @{
...
@par Run the example
  ...
  - Connect J32.4 to J33.4.
  - Input voltage to J33.4. Please input 1.8V for auto test.
