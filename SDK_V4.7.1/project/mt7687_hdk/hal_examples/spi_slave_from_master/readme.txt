 ...
 * @{
 * @addtogroup mt7687_hdk_hal_examples_spi_slave_from_master spi_slave_from_master
 * @{

@par Overview
  - Example description
    - This example is a reference application to use SPI Slave API to
      communicate with SPI Master on the LinkIt 7687 HDK.
...
@par Hardware and software environment
  ...
  - HDK switches and pin configuration
    - SPI pin mapping is listed below.
      ...
      |         |              |                      |              |           |
      |         |  J36.3(GPIO7)|______________________|J34.8(GPIO32) |           |
      |         |              |                      |              |           |
      |         | J36.4(GPIO24)|______________________|J34.7(GPIO29) |           |
      |         |              |                      |              |           |
      |         | J36.5(GPIO25)|______________________|J34.6(GPIO30) |           |
      |         |              |                      |              |           |
      |         | J36.6(GPIO26)|______________________|J34.5(GPIO31) |           |
      |         |______________|                      |______________|           |
      |                        |                      |                          |
      |                        |                      |                          |
...
@par Run the example
  - Build the example project with a command "./build.sh mt7687_hdk
    spi_slave_from_master" under the SDK root folder and download the binary
  ...
  - Run the example. The log "spi_slave_transfer_data_two_boards_example end"
    indicates a successful communication between SPI Master and Slave.
*/
/**
 * @}
 * @}
