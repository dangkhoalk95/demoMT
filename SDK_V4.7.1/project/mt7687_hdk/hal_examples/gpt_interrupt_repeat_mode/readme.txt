 ...
 * @{
 * @addtogroup mt7687_hdk_hal_examples_gpt_interrupt_repeat_mode gpt_interrupt_repeat_mode
 * @{
...
@par Overview
  ...
  - Results
    - The system logs show the repetitive timer fires at an interval of
      1000ms.
...
@par Directory contents
  ...
  - Project configuration files using Keil IDE
    - \b MDK-ARM/gpt_interrupt_repeat_mode.uvprojx:
                             uVision5 project file. Contains the project
                             structure in XML format.
    - \b MDK-ARM/gpt_interrupt_repeat_mode.uvoptx:
...
@par Run the example
  ...
  - Run the example. The log of "Expired at XXX ms." shows the repetitive
    timer fires at an interval of 1000ms and indicates a successful
    operation.
