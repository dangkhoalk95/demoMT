...
Usb_Ep_Info* USB_Get_Intr_Ep(uint8_t *p_num)
{
	...
	*p_num = HAL_USB_MAX_NUMBER_ENDPOINT_TX-gUsbDevice.resource_ep_intr_tx_number-1;
...
Usb_Ep_Info* USB_Get_Bulk_Tx_Ep(uint8_t *p_num)
{
	...
	USB_Check_Ep_Number();
	*p_num = gUsbDevice.resource_ep_bulk_tx_number+3;
...
Usb_Ep_Info* USB_Get_Bulk_Rx_Ep(uint8_t *p_num)
{
	...
	*p_num = gUsbDevice.resource_ep_bulk_rx_number+1;
