...
typedef void (*UART_TX_FUNC)(void); 
typedef void (*UART_RX_FUNC)(void) ; 
...
extern void USB_Acm_CommIf_Enable(void);
extern void USB_Acm_CommIf_Speed_Reset(bool b_other_speed);
extern void USB_Acm_DataIf_Create(void *ifname);
extern void USB_Acm_DataIf_Reset(void);
extern void USB_Acm_DataIf_Enable(void);
extern void USB_Acm_DataIf_Speed_Reset(bool b_other_speed);
