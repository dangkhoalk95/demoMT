...
/* sleep manager example task */
#define SLEEP_MANAGER_EXAMPLE_TASK_NAME          "sleep_manager"
#define SLEEP_MANAGER_EXAMPLE_TASK_STACKSIZE     1024
#define SLEEP_MANAGER_EXAMPLE_TASK_PRIO          TASK_PRIORITY_LOW
