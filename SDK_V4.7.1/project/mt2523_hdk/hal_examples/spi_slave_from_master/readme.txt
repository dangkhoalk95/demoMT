 ...
 * @{
 * @addtogroup mt2523_hdk_hal_examples_spi_slave_from_master spi_slave_from_master
 * @{

@par Overview
  - Example description
    - This example is a reference application to demonstrate how to use the
      SPI API to communicate between SPI Slave and SPI Master devices.
  ...
  - Features of the example project
    - The example project has two parts: 1. LinkIt 2523 HDK operates as SPI
      Slave device (spi_master_to_slave). 2. LinkIt 2523 HDK operates as SPI
      ...
      |          |              |                      |              |          |
      |          CON6301 Left.6 |______________________|CON6301 Left.6           |
      |          |              |                      |              |          |
      |          CON6301 Left.7 |______________________|CON6301 Left.7           |
      |          |              |                      |              |          |
      |          CON6301 Left.8 |______________________|CON6301 Left.8           |
      |          |              |                      |              |          |
      |          CON6301 Left.9 |______________________|CON6301 Left.9           |
      |          |______________|                      |______________|          |
      |                         |                      |                         |
      |                         |                      |                         |
...
@par Run the example
  ...
  - Connect the related pins of the two LinkIt 2523 HDKs shown in the
