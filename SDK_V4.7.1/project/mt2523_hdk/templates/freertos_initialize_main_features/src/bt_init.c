...
#include "FreeRTOS.h"
#include "task.h"
/*This option is to enable NVDM(Non-Volatile Data Management) module.*/
...
void bt_create_task(void)
{
    ...
    if (pdPASS != xTaskCreate(bt_task, BT_EXAMPLE_TASK_NAME, BT_EXAMPLE_TASK_STACKSIZE / sizeof(StackType_t), (void *)local_public_addr, BT_EXAMPLE_TASK_PRIO, NULL)) {
