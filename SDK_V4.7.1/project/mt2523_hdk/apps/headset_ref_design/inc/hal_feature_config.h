...
#define HAL_AUDIO_LOW_POWER_ENABLED
...
/* Enable headphone path dc offset calibration and compensation */
//#define __AFE_HP_DC_CALIBRATION__
/* Enable handset path dc offset calibration and compensation */
//#define __AFE_HS_DC_CALIBRATION__
...
//#define __AFE_I2S_DYNAMIC_SWITCH__ //switch i2s gpio on/off

#define __AFE_HP_ANALOG_DEPOP_SWITCH__
/*This definition determines whether the demo supports HW DEPOP function. If it is not defined, there is no HW DEPOP function on this demo.*/
#if defined(__AFE_HP_ANALOG_DEPOP_SWITCH__)
/*Analog switch trigger level selection, 0:low enable, 1:high enable*/
#define AFE_HP_DEPOP_ENABLE_LEVEL 0
#endif
