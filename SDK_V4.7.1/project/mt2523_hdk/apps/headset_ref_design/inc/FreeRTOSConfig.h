...
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 640 * 1024 ) )//( ( size_t ) ( 280 * 1024 ) )
#else
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 430 * 1024 ) )//( ( size_t ) ( 280 * 1024 ) )
#endif
...
/*MTK_HEAP_SIZE_GUARD_ENABLE: This definition determines whether enable task's heap peak profiling, It's a assistant feature for task's heap usage analyze.*/
