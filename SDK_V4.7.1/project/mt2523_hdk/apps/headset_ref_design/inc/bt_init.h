...
#define BT_TX_BUF_SIZE 10*1024
#define BT_RX_BUF_SIZE 40*1024
...
#define BT_CONNECTION_BUF_SIZE (BT_MAX_LINK_NUM* BT_CONTROL_BLOCK_SIZE_OF_EDR_CONNECTION)
...
#define BT_AWS_TOTAL_CONNECTION_NUM  1 /**<[IMPORTANT!]total num = N1 + N2 + ..., Nx is the really used connection num for link-x, each link may different*/
#define BT_AWS_CONNECTION_BUF_SIZE (BT_AWS_TOTAL_CONNECTION_NUM * BT_CONTROL_BLOCK_SIZE_OF_AWS)
