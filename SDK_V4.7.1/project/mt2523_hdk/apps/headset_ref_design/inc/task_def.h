...
#define BMT_TASK_PRIO TASK_PRIORITY_BELOW_NORMAL
...
/* temp solution because of MTK_NO_PSRAM_ENABLE will be N until slim done */
/*This definition determines if the product version is the same as the description, the following feature can be used.*/
#if (PRODUCT_VERSION == 7687) || (PRODUCT_VERSION == 7697) || (PRODUCT_VERSION == 2533)
#define SYSLOG_QUEUE_LENGTH 256
...
/* BT A2DP AAC DECODER TASK*/
#define BT_A2DP_AAC_DEC_TASK_NAME            "bt_aac_dec_task"
#define BT_A2DP_AAC_DEC_TASK_TASK_STACKSIZE  2048 /*512 bytes!*/
#define BT_A2DP_AAC_DEC_TASK_TASK_PRIO       TASK_PRIORITY_NORMAL
...
#define BT_SINK_APP_TASK_STACKSIZE (4096)
...
/* audio mixer task definition */
#define AUDIO_MIXER_TASK_NAME       "mixer_task"
#define AUDIO_MIXER_TASK_STACKSIZE  2048
#define AUDIO_MIXER_TASK_PRIO       TASK_PRIORITY_SOFT_REALTIME
#define AUDIO_MIXER_QUEUE_LENGTH    20
