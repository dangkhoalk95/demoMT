...
#define SPP_SERVER_TASK_NAME "spp_server_task"
#define SPP_SERVER_TASK_STACK_SIZE (512*4)
#define SPP_SERVER_TASK_PRIO TASK_PRIORITY_NORMAL

/* SPP client task definition */
#define SPP_CLIENT_TASK_NAME "spp_client_task"
#define SPP_CLIENT_TASK_STACK_SIZE (512*4)
#define SPP_CLIENT_TASK_PRIO TASK_PRIORITY_NORMAL
#ifdef __cplusplus
}
#endif
