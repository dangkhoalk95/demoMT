...
static void gattc_connect_cb(bt_status_t status, app_bt_connection_cb_t *param);
...
static void gattc_disconnect_cb(bt_status_t status, bt_hci_evt_disconnect_complete_t *param);
