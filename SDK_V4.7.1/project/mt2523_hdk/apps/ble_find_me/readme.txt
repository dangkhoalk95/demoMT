 ...
 * @{
 * @addtogroup mt2523_hdk_apps_ble_find_me ble_find_me
 * @{

@par Overview
  - Application description
    - This is a reference application to demonstrate usage of Find Me profile
      APIs.
...
@par Directory contents
  - Source and header files
    ...
    - \b src/ble_ias.c:           Immediate Alert service file.
    - \b src/bt_init.c:           Bluetooth initialization file.
    - \b src/ble_fmp_main.c:      Find Me Profile main program.
    ...
    - \b inc/ble_fmp_main.h:      Find Me Profile main program header file.
    - \b inc/ble_ias.h:           GATT service IAS header file.
  - Project configuration files using GCC.
    - \b GCC/feature.mk:  Feature configuration.
    - \b GCC/Makefile:    Makefile.
    - \b GCC/flash.ld:    Linker script.
  - Project configuration files using Keil IDE.
    - \b MDK-ARM/ble_find_me.uvprojx:
                             uVision5 project file. Contains the project
                             structure in XML format.
    - \b MDK-ARM/ble_find_me.uvoptx:
  ...
  - Project configuration files using IAR.
    - \b EWARM/ble_find_me.ewd:  IAR project options. Contains the settings for
                                 the debugger.
    - \b EWARM/ble_find_me.ewp:  IAR project file. Contains the project
                                 structure in XML format.
    - \b EWARM/ble_find_me.eww:  IAR workspace file. Contains project
                                 information.
    - \b EWARM/flash.icf:        Linker script.

@par Run the example
  - Build the sample project with the command "./build.sh mt2523_hdk
    ble_find_me" from the SDK root folder on GCC, or build the project
    ble_find_me.uvprojx from the MDK-ARM folder on Keil, or build the project
    ble_find_me.eww from the EWARM folder on IAR, then download the binary
