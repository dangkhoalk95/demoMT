...
bt_gap_le_smp_pairing_config_t ble_gatt_pairing_config_req = {//mitm, bond, oob
    .maximum_encryption_key_size = 16,
    .io_capability = BT_GAP_LE_SMP_NO_INPUT_NO_OUTPUT,
    .auth_req = BT_GAP_LE_SMP_AUTH_REQ_MITM | BT_GAP_LE_SMP_AUTH_REQ_BONDING
};
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_connect_reset_info
* DESCRIPTION
* Reset connection information pointer
* PARAMETERS
*  info        [IN]        Connect_info pointer
* RETURNS
*  void
*****************************************************************************/
static void ble_gatt_connect_reset_info(ble_gatt_connect_info_t *info)
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_get_bonded_info
* DESCRIPTION
* Get bonded information
* PARAMETERS
*  addr        [IN]        Bluetooth address
* RETURNS
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_connect_gap_power_on_cnf
* DESCRIPTION
* Handle bt power on confirm
* PARAMETERS
*  status      [IN]        Bluetooth status
*  buff        [IN]        Result
* RETURNS
*  bt_status_t
*****************************************************************************/
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_connect_le_set_adv_cnf
* DESCRIPTION
* Handle adv confirm
* PARAMETERS
*  status      [IN]        Bluetooth status
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_connect_le_adv_report_ind
* DESCRIPTION
* Handle adv report ind
* PARAMETERS
*  status      [IN]        Bluetooth status
*  buff        [IN]        Result
* RETURNS
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_connect_le_connect_ind
* DESCRIPTION
* Handle le connection ind
* PARAMETERS
*  status      [IN]        Bluetooth status
*  buff        [IN]        Result
* RETURNS
...
static bt_status_t ble_gatt_connect_le_connect_ind(bt_status_t status, void *buff)
{
    ...
    if (status == BT_STATUS_SUCCESS) {
        ...
        if (info) {
            ...
            ble_ias_dev_connect(info->handle);
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_connect_le_disconnect_ind
* DESCRIPTION
* Handle le disconnection ind
* PARAMETERS
*  status      [IN]        Bluetooth status
*  buff        [IN]        Result
* RETURNS
...
static bt_status_t ble_gatt_connect_le_disconnect_ind(bt_status_t status, void *buff)
{
    ...
    if (info) {
        ...
        ble_ias_dev_disconnect(disconn_ind->connection_handle);
        /* notify app */
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_connect_le_set_scan_cnf
* DESCRIPTION
* Handle le set scan confirm
* PARAMETERS
*  status      [IN]        Bluetooth status
*  buff        [IN]        Result
* RETURNS
...
/*****************************************************************************
* FUNCTION
*  bt_gatt_connect_start_advertising
* DESCRIPTION
* Start advertising
* PARAMETERS
...
static bt_status_t bt_gatt_connect_start_advertising(char *device_name)
{
    ...
    *(adv_data.advertising_data + total_length) = 3;
    *(adv_data.advertising_data + total_length + 1) = BT_GAP_LE_AD_TYPE_16_BIT_UUID_COMPLETE;
    *((uint16_t *)(adv_data.advertising_data + total_length + 2)) = BT_GATT_UUID16_IMMEDIATE_ALERT_SERVICE;
    total_length += 4; // 1 type for length, 1 type for adv type, 2 type for uuid
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_connect_gap_le_get_local_config
* DESCRIPTION
...
/*****************************************************************************
* FUNCTION
*  ble_gatt_connect_gap_le_get_bonding_info
* DESCRIPTION
...
/*****************************************************************************
* FUNCTION
*  bt_gatt_connect_gap_le_get_pairing_config
* DESCRIPTION
