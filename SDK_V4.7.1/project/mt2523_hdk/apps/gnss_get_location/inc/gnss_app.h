...
#define GNSS_TASK_STACK_SIZE 4000 //should be fine tune
#define GNSS_TASK_PRIORITY 3 //should be arrange by scenario

//Feature Config Begin

// This option is used to enable assitance EPO data to GNSS chip
// This option is used to enable download EPO data via BT
...
extern void gnss_app_forward_cmd(int8_t* buf, uint32_t buf_len);
