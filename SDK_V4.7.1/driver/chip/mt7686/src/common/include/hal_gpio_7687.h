...
typedef struct {
    void (*GPIO_IDX_0_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT0
    void (*GPIO_IDX_1_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT1

    void (*GPIO_IDX_3_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT2
    void (*GPIO_IDX_4_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT3
    void (*GPIO_IDX_5_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT4
    void (*GPIO_IDX_6_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT5
    void (*GPIO_IDX_7_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT6


    void (*GPIO_IDX_35_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT19

    void (*GPIO_IDX_37_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT20
    void (*GPIO_IDX_38_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT21
    void (*GPIO_IDX_39_LISR)(ENUM_IOT_GPIO_NAME_T pin); //EINT22
