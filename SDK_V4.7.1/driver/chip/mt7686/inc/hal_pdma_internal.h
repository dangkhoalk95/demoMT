...
typedef enum {
    ...
    PDMA_I2C0_TX = PDMA_START_CHANNEL,          /**< peripheral dma channel 2 */
    PDMA_I2C0_RX = 2,                           /**< peripheral dma channel 3 */
    PDMA_I2C1_TX = 3,                         /**< peripheral dma channel 4 */
    PDMA_I2C1_RX = 4,                         /**< peripheral dma channel 5 */
    PDMA_HIF_TX_RX = 5,                         /**< peripheral dma channel 6 */
...
typedef enum {
    VDMA_START_CHANNEL = 6,               /**< virtual fifo dma start channel */
		
    VDMA_AUDTX = VDMA_START_CHANNEL,     /**< virtual fifo dma channel 7 */
    VDMA_AUDRX = 7,                      /**<virtual fifo  dma channel 8 */
    VDMA_ASYSTX = 8,                      /**<virtual fifo  dma channel 9 */
    VDMA_ASYSRX = 9,                      /**< virtual fifo dma channel 10*/
    VDMA_UART2TX = 10,                    /**<virtual fifo  dma channel 11 */
    VDMA_UART2RX = 11,                    /**< virtual fifo dma channel 12*/
    VDMA_UART1TX = 12,                    /**< virtual fifo dma channel 13 */
    VDMA_UART1RX = 13,                    /**<virtual fifo  dma channel 14 */
