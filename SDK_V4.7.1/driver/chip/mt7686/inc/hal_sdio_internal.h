...
sdio_internal_status_t sdio_wait_last_block_complete(void);
...
sdio_internal_status_t sdio_set_function_interrupt(hal_sdio_function_id_t function,bool is_enable);
