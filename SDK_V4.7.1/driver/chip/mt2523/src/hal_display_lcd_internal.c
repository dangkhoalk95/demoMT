...
__weak const char HAL_LCD_LSCK0_PIN = 0xff;
__weak const char HAL_LCD_LSCK0_PIN_M_GPIO = 0xff;
__weak const char HAL_LCD_LSCK0_PIN_M_LSCK0 = 0xff;
#else
const char __attribute__((weak)) HAL_LCD_LSCK0_PIN = 0xff;
const char __attribute__((weak)) HAL_LCD_LSCK0_PIN_M_GPIO = 0xff;
const char __attribute__((weak)) HAL_LCD_LSCK0_PIN_M_LSCK0 = 0xff;
#endif
