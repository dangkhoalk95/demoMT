...
#define SD_COMMAND6_DESELECT_HIGH_SPEED (0x80FFFFF0)  /*argument of command6 to deselect the high speed interface*/
...
#define MSDC_TIMEOUT_PERIOD_INIT        11000000//
#define MSDC_TIMEOUT_PERIOD_DATA        1500000//
