...
#define I2C_CONTROL_OPEN_DRAIN_SEND_POLLING                (0x0020)
#define I2C_CONTROL_OPEN_DRAIN_SEND_DMA                    (0x0024)
#define I2C_CONTROL_OPEN_DRAIN_RECEIVE_POLLING             (0x0020)
#define I2C_CONTROL_OPEN_DRAIN_RECEIVE_DMA                 (0x0024)
#define I2C_CONTROL_OPEN_DRAIN_SEND_TO_RECEIVE_POLLING     (0x0072)
#define I2C_CONTROL_OPEN_DRAIN_SEND_TO_RECEIVE_DMA         (0x0076)

#define I2C_CONTROL_OPEN_DRAIN_SEND_DMA_EXTEND             (0x0026)
#define I2C_CONTROL_OPEN_DRAIN_RECEIVE_DMA_EXTEND          (0x0026)
#define I2C_CONTROL_OPEN_DRAIN_SEND_TO_RECEIVE_DMA_EXTEND         (0x0076)
