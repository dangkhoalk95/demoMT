...
typedef struct {
    uint32_t RBR; /* RX buffer register */
    uint32_t THR; /* TX holding register */
    uint32_t DLL; /* Divisor latch register */
    uint32_t IER; /* Interrupt enable register */
    uint32_t DLM; /* Divisor latch register */
    uint32_t IIR; /* Interrupt identification register */
    uint32_t FCR; /* FIFO control register */
    uint32_t EFR; /* Enhanced feature register */
    uint32_t LCR; /* Line control register */
    uint32_t MCR; /* Modem control register */
    uint32_t XON1; /* XON1 char register */
    uint32_t LSR; /* Line status register */
    uint32_t XON2; /* XON2 char register */
    uint32_t XOFF1; /* XOFF1 char register */
    uint32_t SCR; /* Scratch register */
    uint32_t XOFF2; /* XOFF2 char register */
    uint32_t AUTOBAUD_EN; /* Autoband detect enable register */
    uint32_t HIGHSPEED; /* High speed mode register */
    uint32_t SAMPLE_COUNT; /* Sample counter register */
    uint32_t SAMPLE_POINT; /* Sample point register */
    uint32_t AUTOBAUD_REG; /* Auto Baud Monitor Register */
    uint32_t RATEFIX_AD; /* Clock Rate Fix Register */
    uint32_t AUTOBAUDSAMPLE; /* Auto Baud Sample Register */
    uint32_t GUARD; /* Guard Time Added reRegister */
    uint32_t ESCAPE_DAT; /* Escape character register */
    uint32_t ESCAPE_EN; /* Escape enable register */
    uint32_t SLEEP_EN; /* Sleep enable register */
    uint32_t DMA_EN; /* DMA enable register */
    uint32_t RXTRI_AD; /* Rx Trigger Address */
    uint32_t FRACDIV_L; /* Fractional Divider LSB Address */
    uint32_t FRACDIV_M; /* Fractional Divider MSB Address */
    uint32_t FCR_RD; /* FIFO Control Register */
    uint32_t TX_ACTIVE_EN; /* TX Active Enable Address */
} UART_REGISTER_LIST_T;
