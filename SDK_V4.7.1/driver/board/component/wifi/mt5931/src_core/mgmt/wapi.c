...
/*
** $Id: //Department/DaVinci/TRUNK/MT6620_5931_WiFi_Driver/mgmt/wapi.c#4 $
*/
...
)
{
    ...
    MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "wapiParseWapiIE");
    ...
    if (prInfoElem->ucLength < 6) {
        MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WARNING, "WAPI IE length too short (length=%d)\n", prInfoElem->ucLength);
        return FALSE;
    }
    ...
    if (u2Version != 1) {
        MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WARNING, "Unsupported WAPI IE version: %d\n", u2Version);
        return FALSE;
    }
    ...
    do {
        ...
        if (u4RemainWapiIeLen < 2) {
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WARNING, "Fail to parse WAPI IE in auth & key mgt suite count (IE len: %d)\n",
                             prInfoElem->ucLength);
            return FALSE;
        }
        ...
        if (u4RemainWapiIeLen < (INT_32) i) {
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WARNING, "Fail to parse WAPI IE in auth & key mgt suite list (IE len: %d)\n",
                             prInfoElem->ucLength);
            return FALSE;
        }
        ...
        if (u4RemainWapiIeLen < 2) {
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WARNING, "Fail to parse WAPI IE in pairwise cipher suite count (IE len: %d)\n",
                             prInfoElem->ucLength);
            return FALSE;
        }
        ...
        if (u4RemainWapiIeLen < (INT_32) i) {
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WARNING, "Fail to parse WAPI IE in pairwise cipher suite list (IE len: %d)\n",
                             prInfoElem->ucLength);
            return FALSE;
        }
        ...
        if (u4RemainWapiIeLen < 4) {
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WARNING, "Fail to parse WAPI IE in group cipher suite (IE len: %d)\n",
                             prInfoElem->ucLength);
            return FALSE;
        }
        ...
        if (u4RemainWapiIeLen < 2) {
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WARNING, "Fail to parse WAPI IE in WAPI capabilities (IE len: %d)\n",
                             prInfoElem->ucLength);
            return FALSE;
        }
    ...
    MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "WAPI: version %d, group key cipher suite %02x-%02x-%02x-%02x\n",
    ...
    if (pucPairSuite) {
        ...
        for (i = 0; i < (UINT_32) u2PairSuiteCount; i++) {
            ...
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "WAPI: pairwise key cipher suite [%d]: %02x-%02x-%02x-%02x\n",
        ...
        MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "WAPI: pairwise key cipher suite: %02x-%02x-%02x-%02x (default)\n",
    ...
    if (pucAuthSuite) {
        ...
        for (i = 0; i < (UINT_32) u2AuthSuiteCount; i++) {
            ...
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "WAPI: AKM suite [%d]: %02x-%02x-%02x-%02x\n",
        ...
        MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "WAPI: AKM suite: %02x-%02x-%02x-%02x (default)\n",
    ...
    MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "WAPI: cap: 0x%04x\n", prWapiInfo->u2WapiCap);
...
)
{
    ...
    MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "wapiPerformPolicySelection");
    ...
    if (prBss->fgIEWAPI) {
        ...
        if (prAdapter->rWifiVar.rConnSettings.fgWapiMode == FALSE) {
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_ERROR, "-- No Protected BSS\n");
            return TRUE;
        } else {
            MT5931_WAP_TRACE(MOD_WNDRV, TRACE_ERROR, "WAPI Information Element does not exist.\n");
            return FALSE;
        }
    }
    ...
    if (u4PairwiseCipher == 0 || u4GroupCipher == 0) {
        MT5931_WAP_TRACE(MOD_WNDRV, TRACE_ERROR, "Failed to select pairwise/group cipher (0x%08lx/0x%08lx)\n",
    ...
    if (u4AkmSuite == 0) {
        MT5931_WAP_TRACE(MOD_WNDRV, TRACE_ERROR, "Cannot support any AKM suites\n");
        return FALSE;
    }

    MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "Selected pairwise/group cipher: %02x-%02x-%02x-%02x/%02x-%02x-%02x-%02x\n",
    ...
    MT5931_WAP_TRACE(MOD_WNDRV, TRACE_WAPI, "Selected AKM suite: %02x-%02x-%02x-%02x\n",
