...
/*
** $Id: //Department/DaVinci/TRUNK/MT6620_5931_WiFi_Driver/mgmt/sec_fsm.c#11 $
*/
...
)
{
    ...
    if (!IS_STA_IN_AIS(prSta)) {
        DBGLOG(RSN, WARN, ("Counter Measure should occur at AIS network!!\n"));
        //ASSERT(0);
        return;
    }
...
)
{
    ...
    temp_sta = prSta; //backup sta record
...
)
{
    ...
    do {
        ...
        MT5931_WAP_TRACE(MOD_WNDRV, TRACE_STATE, "SEC_STATE_TRANSITION: %d -> %d",
...
)
{
    ...
    case SEC_STATE_CHECK_OK :
        ...
        break;
    default:
        DBGLOG(RSN, ERROR, ("Rcv 2nd EAPoL at %s\n", apucDebugSecState[prSecInfo->eCurrentState]));
    ...
    )
{
    ...
    case SEC_STATE_CHECK_OK :
        ...
        break;
    default:
        DBGLOG(RSN, ERROR, ("Rcv thh EAPoL Tx done at %s\n", apucDebugSecState[prSecInfo->eCurrentState]));
    ...
    )
{
    ...
    if (rTxDoneStatus != TX_RESULT_SUCCESS) {
        DBGLOG(RSN, WARN, ("Error EAPoL fram fail to send!!\n"));
        //ASSERT(0);
        return;
    }
    ...
    )
{
    ...
    case SEC_STATE_SEND_DEAUTH:
		...
		KAL_PUBLIC_TRACE(TRACE_INFO, "eNextState %d \n", eNextState);
