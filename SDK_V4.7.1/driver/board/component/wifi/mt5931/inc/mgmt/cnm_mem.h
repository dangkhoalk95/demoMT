...
/*
** $Id: //Department/DaVinci/TRUNK/MT6620_5931_WiFi_Driver/include/mgmt/cnm_mem.h#14 $
*/
...
struct _STA_RECORD_T {
    ...
    BOOLEAN          fgIsAuthLoopback;
    UINT_8           ucAuthTxSeqNum;
    BOOLEAN          fgIsAssocLoopback;
    UINT_8           ucAssocTxSeqNum;
    UINT_32          u4InactTime;
    BOOLEAN          fgIsAddStaReq;
