...
/*
** $Id: //Department/DaVinci/TRUNK/MT6620_5931_WiFi_Driver/include/mgmt/cnm_timer.h#2 $
*/
...
#if defined(WCN_MAUI)
#define MGMT_MAX_TIMEOUT_INTERVAL       ((UINT_32)0xffffffff)
#else
...
#if defined (WCN_MAUI)
#define TIME_BEFORE(a,b)        ((UINT_32)(a) < (UINT_32)(b))
#else
