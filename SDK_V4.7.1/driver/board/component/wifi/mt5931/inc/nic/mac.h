...
/*
** $Id: //Department/DaVinci/TRUNK/MT6620_5931_WiFi_Driver/include/nic/mac.h#10 $
*/
...
typedef  struct _wps_attr_hdr {
    UINT_16  Id;
    UINT_16  Len;
} __KAL_ATTRIB_PACKED__ WPS_ATTR_HDR, *P_WPS_ATTR_HDR;

typedef  struct _wps_attr_version {
    WPS_ATTR_HDR  Hdr;
    UINT_8   Ver;
} __KAL_ATTRIB_PACKED__ WPS_ATTR_VER, *P_WPS_ATTR_VER;

typedef struct _wps_attr_req_type {
    WPS_ATTR_HDR Hdr;
    UINT_8  ReqType;
} __KAL_ATTRIB_PACKED__ WPS_ATTR_REQTYPE, *P_WPS_ATTR_REQTYPE;

typedef struct _wps_attr_cfg_method {
    WPS_ATTR_HDR Hdr;
    UINT_16 CfgMethod;
} __KAL_ATTRIB_PACKED__ WPS_ATTR_CFG_METHOD, *P_WPS_ATTR_CFG_METHOD;

typedef struct _wps_attr_uuid {
    WPS_ATTR_HDR Hdr;
    UINT_8 Uuid[16];
} __KAL_ATTRIB_PACKED__ WPS_ATTR_UUID, P_WPS_ATTR_UUID;

typedef struct _wps_attr_pridev {
    WPS_ATTR_HDR Hdr;
    UINT_16 CatId;
    UINT_32 Oui;
    UINT_16 SubCat;
} __KAL_ATTRIB_PACKED__ WPS_ATTR_PRIDEV, *P_WPS_ATTR_PRIDEV;

typedef struct _wps_attr_rf_bands {
    WPS_ATTR_HDR Hdr;
    UINT_8  RF;
} __KAL_ATTRIB_PACKED__ WPS_ATTR_RF_BANDS, *P_WPS_ATTR_RF_BANDS;

typedef struct _wps_attr_assoc_stat {
    WPS_ATTR_HDR  Hdr;
    UINT_16 State;
} __KAL_ATTRIB_PACKED__ WPS_ATTR_ASSOC_STAT, *P_WPS_ATTR_ASSOC_STAT;

typedef struct _wps_attr_cfg_err {
    WPS_ATTR_HDR Hdr;
    UINT_16 Error;
} __KAL_ATTRIB_PACKED__ WPS_ATTR_CFG_ERR, *P_WPS_ATTR_CFG_ERR;


typedef  struct _wps_attr_dev_pswd_id {
    WPS_ATTR_HDR  Hdr;
    UINT_16  PwsdId;
} __KAL_ATTRIB_PACKED__  WPS_ATTR_DEV_PSWD_ID, *P_WPS_ATTR_DEV_PSWD_ID;

typedef  struct _wps_attr_setup_state {
    WPS_ATTR_HDR  Hdr;
    UINT_8  State;
} __KAL_ATTRIB_PACKED__ WPS_ATTR_SETUP_STATE, *P_WPS_ATTR_SETUP_STATE;

typedef  struct _wps_attr_ap_locked {
    WPS_ATTR_HDR  Hdr;
    UINT_8  Locked;
} __KAL_ATTRIB_PACKED__  WPS_ATTR_AP_LOCKED, *P_WPS_ATTR_AP_LOCKED;

typedef  struct _wps_attr_select_reg {
    WPS_ATTR_HDR  Hdr;
    UINT_8  Select;
} __KAL_ATTRIB_PACKED__  WPS_ATTR_SELECT_REG, *P_WPS_ATTR_SELECT_REG;

typedef  struct _wps_attr_reg_cfg_method {
    WPS_ATTR_HDR  Hdr;
    UINT_8  CfgMethod;
} __KAL_ATTRIB_PACKED__  WPS_ATTR_REG_CFG_METHOD, *P_WPS_ATTR_REG_CFG_METHOD;

typedef  struct _wps_attr_resptype {
    WPS_ATTR_HDR  Hdr;
    UINT_8  RespType;
} __KAL_ATTRIB_PACKED__  WPS_ATTR_RESPTYPE, *P_WPS_ATTR_RESPTYPE;

typedef  struct _wps_attr_manuf {
    WPS_ATTR_HDR  Hdr;
    UINT_8  Name[WPS_MANUFACTURE_LEN];
} __KAL_ATTRIB_PACKED__  WPS_ATTR_MANUF, *P_WPS_ATTR_MANUF;

typedef  struct _wps_attr_model_name {
    WPS_ATTR_HDR  Hdr;
    UINT_8  Name[WPS_MODEL_NAME_LEN];
} __KAL_ATTRIB_PACKED__  WPS_ATTR_MODEL_NAME, *P_WPS_ATTR_MODEL_NAME;

typedef struct _wps_attr_model_num {
    WPS_ATTR_HDR  Hdr;
    UINT_8  Num[WPS_MODEL_NUM_LEN];
} __KAL_ATTRIB_PACKED__  WPS_ATTR_MODEL_NUM, *P_WPS_ATTR_MODEL_NUM;

typedef struct _wps_attr_serial_num {
    WPS_ATTR_HDR  Hdr;
    UINT_8  Num[WPS_SERIAL_NUM_LEN];
} __KAL_ATTRIB_PACKED__  WPS_ATTR_SERIAL_NUM, *P_WPS_ATTR_SERIAL_NUM;

typedef struct _wps_attr_dev_name {
    WPS_ATTR_HDR  Hdr;
    UINT_8  Name[WPS_DEV_NAME_LEN];
} __KAL_ATTRIB_PACKED__  WPS_ATTR_DEV_NAME, *P_WPS_ATTR_DEV_NAME;

typedef struct _wfa_sub_attr_ver {
    UINT_8 Id;
    UINT_8 Len;
    UINT_8 Ver;
} __KAL_ATTRIB_PACKED__  WFA_SUB_ATTR_VER, *P_WFA_SUB_ATTR_VER;

typedef struct _wfa_sub_attr_mac {
    UINT_8 Id;
    UINT_8 Len;
    UINT_8 MacList[MAC_ADDR_LEN][5];
} __KAL_ATTRIB_PACKED__  WFA_SUB_ATTR_MAC, *P_WFA_SUB_ATTR_MAC;

typedef struct _wps_attr_wfa_ext {
    WPS_ATTR_HDR Hdr;
    UINT_8  VID[3]; /*0x00372a*/
} __KAL_ATTRIB_PACKED__  WPS_ATTR_WFA_EXT, *P_WPS_ATTR_WFA_EXT;

typedef struct _wps_probe_t {
    UINT_8  ucId;
    UINT_8  ucLength;
    UINT_32  Oui;
    WPS_ATTR_VER             Ver;
    WPS_ATTR_REQTYPE         ReqType;
    WPS_ATTR_CFG_METHOD      CfgMethod;
    WPS_ATTR_UUID            Uuid;
    WPS_ATTR_PRIDEV          PrimDev;
    WPS_ATTR_RF_BANDS        RfBands;
    WPS_ATTR_ASSOC_STAT      AssocStat;
    WPS_ATTR_CFG_ERR         CfgError;
    WPS_ATTR_DEV_PSWD_ID     DevPswdId;
    /*for wps 2.0*/
    WPS_ATTR_MANUF           Manuf;
    WPS_ATTR_MODEL_NAME      ModelName;
    WPS_ATTR_MODEL_NUM       ModelNum;
    WPS_ATTR_DEV_NAME        DevName;
    /*netested WFA attribute*/
    WPS_ATTR_WFA_EXT        WfaExt;
    WFA_SUB_ATTR_VER        WfaVer;
} __KAL_ATTRIB_PACKED__  WPS_PROBE_T, *P_WPS_PROBE_T;

typedef struct _wps_assoc_t {
    UINT_8  ucId;
    UINT_8  ucLength;
    UINT_32  Oui;
    WPS_ATTR_VER  Ver;
    ...
    WPS_ATTR_WFA_EXT        WfaExt;
    WFA_SUB_ATTR_VER        WfaVer;
} __KAL_ATTRIB_PACKED__  WPS_ASSOC_T, *P_WPS_ASSOC_T;

typedef struct _wps_prob_resp {
    UINT_8  ucId;
    UINT_8  ucLength;
    UINT_32 Oui;
    WPS_ATTR_VER    Ver;
    WPS_ATTR_SETUP_STATE    WpsSetup;
    WPS_ATTR_AP_LOCKED      Locked;
    WPS_ATTR_SELECT_REG     SelectReg;
    WPS_ATTR_DEV_PSWD_ID    DevPswdId;
    WPS_ATTR_REG_CFG_METHOD   SelectRegMethod;
    WPS_ATTR_RESPTYPE        RespType;
    WPS_ATTR_UUID            Uuid;
    WPS_ATTR_MANUF          Manuf;
    WPS_ATTR_MODEL_NAME     ModelName;
    WPS_ATTR_MODEL_NUM      ModelNum;
    WPS_ATTR_SERIAL_NUM     SerialNum;
    WPS_ATTR_PRIDEV         PrimDev;
    WPS_ATTR_DEV_NAME       DevName;
    WPS_ATTR_CFG_METHOD     CfgMethod;
    WPS_ATTR_RF_BANDS       RfBands;
    ...
    WPS_ATTR_WFA_EXT        WfaExt;
    WFA_SUB_ATTR_VER        WfaVer;
    WFA_SUB_ATTR_MAC        WfaMacList;
} __KAL_ATTRIB_PACKED__  WPS_PROBE_RESP_T, *P_WPS_PROBE_RESP_T;
...
#define WPS_ATTR_VER_ST(fp)        ((WPS_ATTR_VER*)fp)
#define WPS_ATTR_REQTYPE_ST(fp)    ((WPS_ATTR_REQTYPE*)fp)
#define WPS_ATTR_CFG_METHOD_ST(fp) ((WPS_ATTR_CFG_METHOD*)fp)
#define WPS_ATTR_UUID_ST(fp)        ((WPS_ATTR_UUID*)fp)
#define WPS_ATTR_PRIDEV_ST(fp)        ((WPS_ATTR_PRIDEV*)fp)
#define WPS_ATTR_RF_ST(fp)          ((WPS_ATTR_RF_BANDS*)fp)
#define WPS_ATTR_ASSOC_STAT_ST(fp)        ((WPS_ATTR_ASSOC_STAT*)fp)
#define WPS_ATTR_CFG_ERR_ST(fp)        ((WPS_ATTR_CFG_ERR*)fp)
#define WPS_ATTR_DEV_PSWD_ID_ST(fp)   ((WPS_ATTR_DEV_PSWD_ID*)fp)

#define WPS_ATTR_SETUP_STATE_ST(fp)     ((P_WPS_ATTR_SETUP_STATE)fp)
#define WPS_ATTR_AP_LOCKED_ST(fp)       ((P_WPS_ATTR_AP_LOCKED)fp)
#define WPS_ATTR_SELECT_REG_ST(fp)      ((P_WPS_ATTR_SELECT_REG)fp)
#define WPS_ATTR_REG_CFG_METHOD_ST(fp)  ((P_WPS_ATTR_REG_CFG_METHOD)fp)
#define WPS_ATTR_RESPTYPE_ST(fp)        ((P_WPS_ATTR_RESPTYPE)fp)
#define WPS_ATTR_MANUF_ST(fp)           ((P_WPS_ATTR_MANUF)fp)
#define WPS_ATTR_MODEL_NAME_ST(fp)      ((P_WPS_ATTR_MODEL_NAME)fp)
#define WPS_ATTR_MODEL_NUM_ST(fp)       ((P_WPS_ATTR_MODEL_NUM)fp)
#define WPS_ATTR_SERIAL_NUM_ST(fp)       ((P_WPS_ATTR_SERIAL_NUM)fp)
#define WPS_ATTR_DEV_NAME_ST(fp)        ((P_WPS_ATTR_DEV_NAME)fp)

#define WPS_ATTR_WFA_EXT_ST(fp)        ((P_WPS_ATTR_WFA_EXT)fp)
#define WFA_SUB_ATTR_VER_ST(fp)        ((P_WFA_SUB_ATTR_VER)fp)

#define WPS_PROBE_IE(fp)        ((P_WPS_PROBE_T)fp)
#define WPS_ASSOC_IE(fp)        ((P_WPS_ASSOC_T)fp)
#define WPS_PROBE_RESP_IE(fp)   ((P_WPS_PROBE_RESP_T)fp)
#define WPS_ATTR_HDR_ST(fp)     ((P_WPS_ATTR_HDR)fp)
#define WPS_ATTR_ID(fp)         ((P_WPS_ATTR_HDR)fp->Id)
