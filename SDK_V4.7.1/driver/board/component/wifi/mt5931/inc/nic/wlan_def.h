...
/*
** $Id: //Department/DaVinci/TRUNK/MT6620_5931_WiFi_Driver/include/nic/wlan_def.h#22 $
*/
...
/*WPS acquire the data encoding in BE*/
#define WPA_GET_BE16(a) ((UINT_16) (((a)[0] << 8) | (a)[1]))
#define WPA_PUT_BE16(a, val)            \
    do {                    \
        (a)[0] = ((UINT_16) (val)) >> 8;    \
        (a)[1] = ((UINT_16) (val)) & 0xff;  \
    } while (0)

#define WPA_GET_LE16(a) ((UINT_16) (((a)[1] << 8) | (a)[0]))
#define WPA_PUT_LE16(a, val)            \
    do {                    \
        (a)[1] = ((UINT_16) (val)) >> 8;    \
        (a)[0] = ((UINT_16) (val)) & 0xff;  \
    } while (0)

#define WPA_GET_BE24(a) ((((UINT_32) (a)[0]) << 16) | \
                        (((UINT_32) (a)[1]) << 8) | \
                        ((UINT_32) (a)[2]))
#define WPA_PUT_BE24(a, val)                    \
    do {                            \
        (a)[0] = (UINT_8) ((((UINT_32) (val)) >> 16) & 0xff);   \
        (a)[1] = (UINT_8) ((((UINT_32) (val)) >> 8) & 0xff);    \
        (a)[2] = (UINT_8) (((UINT_32) (val)) & 0xff);       \
    } while (0)

#define WPA_GET_BE32(a) ((((UINT_32) (a)[0]) << 24) | \
                        (((UINT_32) (a)[1]) << 16) | \
                        (((UINT_32) (a)[2]) << 8) | \
                        ((UINT_32) (a)[3]))
#define WPA_PUT_BE32(a, val)                    \
    do {                            \
        (a)[0] = (UINT_8) ((((UINT_32) (val)) >> 24) & 0xff);   \
        (a)[1] = (UINT_8) ((((UINT_32) (val)) >> 16) & 0xff);   \
        (a)[2] = (UINT_8) ((((UINT_32) (val)) >> 8) & 0xff);    \
        (a)[3] = (UINT_8) (((UINT_32) (val)) & 0xff);       \
    } while (0)

#define WPA_GET_LE32(a) ((((UINT_32) (a)[3]) << 24) | \
                        (((UINT_32) (a)[2]) << 16) | \
                        (((UINT_32) (a)[1]) << 8) | \
                        ((UINT_32) (a)[0]))
#define WPA_PUT_LE32(a, val)                    \
    do {                            \
        (a)[3] = (UINT_8) ((((UINT_32) (val)) >> 24) & 0xff);   \
        (a)[2] = (UINT_8) ((((UINT_32) (val)) >> 16) & 0xff);   \
        (a)[1] = (UINT_8) ((((UINT_32) (val)) >> 8) & 0xff);    \
        (a)[0] = (UINT_8) (((UINT_32) (val)) & 0xff);       \
    } while (0)
