...
/*
** $Id: //Department/DaVinci/TRUNK/MT6620_5931_WiFi_Driver/include/nic_cmd_event.h#58 $
*/
...
typedef struct _CMD_ACCESS_REG {
    UINT_32     u4Address;
    UINT_32     u4Data;
} CMD_ACCESS_REG, *P_CMD_ACCESS_REG, EVENT_ACCESS_REG, *P_EVENT_ACCESS_REG;
...
#ifdef __WIFI_SNIFFER_SUPPORT__
typedef struct _CMD_PARAM_SET_SNIFFER_MODE_T {
    UINT_8              ucOnOffSwitch;
    UINT_8              ucChannelNum;
    UINT_8              cMinRssi; //RCPI :range 20~220
    UINT_8              cMaxRssi; //RCPI:range 20~220
    UINT_16             u2MinPacketLength; //range 20~2048
    UINT_16             u2MaxPacketLength; //range 20~2048
    UINT_32             ucSnifferFilterOptions;
} CMD_SET_SNIFFER_MODE_T, *P_CMD_SET_SNIFFER_MODE_T;
#endif
