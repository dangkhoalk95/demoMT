...
#define INT_FLAT_EN_POS       (1U<<7)
#define INT_FWM_EN_POS        (1U<<6)

#define INT_FLAT_MAP1_POS     (1U<<7)
#define INT_FWM_MAP1_POS      (1U<<6)

/* 0x1F bit 7 */
#define FLAT_INT    (1U<<7)
#define FLAT_STATUS (1U<<31)
#define FWM_INT     (1U<<14)
