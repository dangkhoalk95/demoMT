...
//  {0x3318,0x303E5AD2},    //Large PD (TIA=100KOhm,PGA=6,Cp=+75pF)
//  {0x3318,0x30265292},    //Large PD (TIA=100KOhm,PGA=1,Cp=+200pF)
//  {0x3318,0x303E5AED},    //Large PD (TIA=10KOhm,PGA=6,Cp=+75pF)
//  {0x3318,0x303E10AD},    //Large PD (TIA=10KOhm,PGA=6,Cp=+20pF)
    {0x3318,0x303E18E4},    //Large PD (TIA=25KOhm,PGA=6,Cp=+25pF)
