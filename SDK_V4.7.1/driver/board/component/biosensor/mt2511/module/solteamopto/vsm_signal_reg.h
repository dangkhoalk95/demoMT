...
#else
    //{0x2330, 0x01380182},   //LED1 delay 10code
    //{0x2334, 0x01380182},   //LED2 delay 10code
    {0x2330, 0x01220182},   //LED1 delay 32code
    {0x2334, 0x01220182},   //LED2 delay 32code
#endif
...
//  {0x3318,0x303E4212},  //small PD (TIA=100KOhm,PGA=6,Cp=+50pF)
    {0x3318,0x303EFFD2},    //Large PD (TIA=100KOhm,PGA=6,Cp=+250pF)
...
//  {0x3368, 0x08B6270A}, //NUMAVG=2
    ...
    {0x3370,0x04096564}, //AFE SI CON-PPG 64Hz for AF
    {0x3378,0x0008630F}, //AFE BI CON0-PPG 64Hz for AF
    {0x337C,0x00004080}, //AFE BI CON1-PPG 64Hz for AF
    {0x3384,0xFF85FF64}, //LPF coeff-PPG 64Hz for AF
    {0x3388,0xFF30FF02}, //LPF coeff-PPG 64Hz for AF
    {0x338C,0xFF0FFF9F}, //LPF coeff-PPG 64Hz for AF
    {0x3390,0x00F90355}, //LPF coeff-PPG 64Hz for AF
    {0x3394,0x06C10B1E}, //LPF coeff-PPG 64Hz for AF
    {0x3398,0x1013151F}, //LPF coeff-PPG 64Hz for AF
    {0x339C,0x19A71D13}, //LPF coeff-PPG 64Hz for AF
    {0x33A0,0x1EEA0000}, //LPF coeff-PPG 64Hz for AF      
#else
...
signal_data_t VSM_SIGNAL_PPG1_512HZ_array[]={
    ...
    {0x2334, 0x004100C1},   //LED2
#else
    {0x2330, 0x01020182},   //LED1
    {0x2334, 0x01020182},   //LED2
#endif
    {0x2338, 0x008000C0},   //SAMPLED1
    {0x233C, 0x02020242},   //SAMPLED2
    {0x2340, 0x01410181},   //SAMPAMB1
