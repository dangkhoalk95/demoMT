...
/* WLAN CHIP Capability definitions */
/*
#define WLAN_SUPPORT_11b_MODE   BIT(0)
#define WLAN_SUPPORT_11g_MODE   BIT(1)
#define WLAN_SUPPORT_11n_MODE   BIT(2)
*/
#define WLAN_SUPPORT_11b_MODE   ((kal_uint32) 1UL << (0))
#define WLAN_SUPPORT_11g_MODE   ((kal_uint32) 1UL << (1))
#define WLAN_SUPPORT_11n_MODE   ((kal_uint32) 1UL << (2))
#define WLAN_SUPPORT_TX_PWR_0_5_DBM    ((kal_uint32) 1UL << (16))
...
typedef enum {
    WNDRV_RX_ANT_DIVERSITY_AGC = 0,  /* AGC based selection */
...
typedef struct {
    kal_uint16  u2Offset; /* Addressing space is determined by efuse size. */
    kal_uint32  u4Value;
...
typedef union {
    ...
    wndrv_test_rx_bw_struct        rx_bw;           /* WNDRV_TEST_SET_RX_BW */
    wndrv_test_tx_bw_struct        tx_bw;           /* WNDRV_TEST_SET_TX_BW */
    wndrv_test_tx_gi_struct        tx_gi;           /* WNDRV_TEST_SET_TX_GI */
    wndrv_test_tx_mode_sel_struct  tx_mode_sle;     /* WNDRV_TEST_SET_TX_MODE_SEL */
