...
#if defined(BL_SD_MODULE_ENABLED) || defined(HAL_SDIO_MODULE_ENABLED)
...
#define MSDC_TIMEOUT_PERIOD_INIT        1100    /* x1ms*/
#define MSDC_TIMEOUT_PERIOD_DATA        150        /* x10ms*/
#define MSDC_TIMEOUT_PERIOD_COMMAND     50        /* x10ms*/
...
#endif /*defined(BL_SD_MODULE_ENABLED) || defined(HAL_SDIO_MODULE_ENABLED)*/
