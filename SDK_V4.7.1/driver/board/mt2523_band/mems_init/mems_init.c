...
void bsp_sensor_peripheral_init(void)
{
...
#endif
#endif //end of BMA255_USE_POLLING
    #endif


#ifdef MTK_SENSOR_BIO_USE_MT2511
    #ifdef MT2511_USE_IRQ
    /* GPIO[4] function1 for EINT3, MT2511 */
    hal_pinmux_set_function(HAL_GPIO_8, 1);
    ...
    hal_eint_init(HAL_EINT_NUMBER_7, &eint7_config);
    vsm_eint_set(HAL_EINT_NUMBER_7);
    hal_eint_register_callback(HAL_EINT_NUMBER_7, vsm_eint_handler, HAL_EINT_NUMBER_7);
#ifdef HAL_EINT_FEATURE_MASK
...
void bsp_sensor_peripheral_init(void)
{
    ...
    /* Config I2C0 */
    mems_i2c_init(HAL_I2C_MASTER_0, HAL_I2C_FREQUENCY_400K);
    /* GPIO[5] function1 for EINT10, BMA255 */
    ...
    #ifdef MT2511_USE_IRQ
    /* GPIO[4] function1 for EINT3, MT2511 */
    hal_pinmux_set_function(HAL_GPIO_4, 1);
    hal_eint_config_t eint3_config;
    //eint3_config.trigger_mode = HAL_EINT_EDGE_RISING;
    eint3_config.trigger_mode = HAL_EINT_EDGE_RISING;
    //eint3_config.debounce_time = 10;
    eint3_config.debounce_time = 10;
    hal_eint_init(HAL_EINT_NUMBER_3, &eint3_config);
    vsm_eint_set(HAL_EINT_NUMBER_3);
    hal_eint_register_callback(HAL_EINT_NUMBER_3, vsm_eint_handler, HAL_EINT_NUMBER_3);
#ifdef HAL_EINT_FEATURE_MASK
    hal_eint_unmask(HAL_EINT_NUMBER_3);
#endif
    #endif
#endif
