...
C_FILES  += $(MT2523_WATCH_SRC)/touch_panel/it7258/touch_panel_custom_ite.c
...
CFLAGS  += -I$(SOURCE_DIR)/driver/board/mt2523_watch/touch_panel/gt9137
CFLAGS  += -I$(SOURCE_DIR)/driver/board/mt2523_watch/touch_panel/it7258
CFLAGS  += -I$(SOURCE_DIR)/driver/board/mt2523_watch/touch_panel/config
##
## MTK_CTP_ENABLE
