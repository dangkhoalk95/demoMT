...
*/
const int ppg_control_max_tia = MT2511_PPG_TIA_GAIN_050K;
...
*/
const int ppg_init_ambdac_current = 4;
const int ppg_init_led_current = 128;
const int ppg_init_tia_gain = MT2511_PPG_TIA_GAIN_010K; 

/** 
 * @brief threshold for watch off to on. 
*/
const int ppg_amb_on_threshold = -24400;
const int ppg_amb_variation_on_threshold = 1000;
const int ppg_Ipd_led_on_threshold = 18675;

/** 
 * @brief threshold for watch on to off. 
*/
const int ppg_Ipd_led_off_threshold = 15000;
const int ppg_Ipd_amb_off_threshold = 1189500;
const int ppg_amb_variation_off_threshold = 1000; 
const int ppg_amb_variation_off_threshold_zero = 50000; 
const int ppg_Ipd_amb_led_off_threshold = 13000;
