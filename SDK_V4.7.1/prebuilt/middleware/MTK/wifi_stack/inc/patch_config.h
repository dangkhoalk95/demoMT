 ...
 * 
 * 3) Code change description brief:condtion for memcpy is changed sothat througput increases >20Mbps
 * 
 * 4) Unit Test Result:PASS
 * 
 * 
...
/* Need to set MTK_WIFI_CONFIGURE_FREE_ENABLE = y in gva/config/chip/mt7687/chip.mk after enabling this patch */
...
/*DTIM 10 Low Power Issue*/
/*patch size:   16Bytes*/
#define MT7687_BORA00007018				0
...
/*Connection Time Optimization for Amazon (Join SKIP)*/
/*patch size:   460 Bytes*/
#define MT7687_BORA00007021				0

/*Ip address,Mac address and L3 Port based filter for packets destined to CM4*/
/*patch size:   944 Bytes*/
#define MT7687_BORA00007098				0

/*Dbg Log to host Combine and send function*/
/*pacth Size : 1.8kB  Bytes*/
#define MT7687_BORA00007116				0

/*MT7697 to MT7615 AP idle over 30 sec, ping will time out.*/
/*pacth Size :  -8 Bytes*/
#define MT7687_BORA00007122				0

/*Won't add to SCAN Table if SSID is null*/
/*pacth Size :  388Bytes*/
#define MT7687_BORA00007121				1
...
/*WIFI Privilege Mechanism*/
/*pacth Size :  156Bytes*/
#define MT7687_BORA00007123             0
...
/*added fix for enable/disable Force PWM on WIFI Wake up/sleep*/
/*Patch Size : 132 Bytes*/
#define MT7687_BORA00007247			  0
...
/* Remove Assert Statement From Mutiple Free */
/*Patch Size: -48Bytes */
#define MT7687_BORA00007292			 0
...
/*Patch Size:  408 Bytes */
#define MT7687_BORA00007373				0

/*Amazon Security Mode optimization*/
/*Patch Size:  -24 Bytes */

#define MT7687_BORA00007413				0

/*Ble On/OFF based on the project*/
/*Patch Size:   206 Bytes */

#define MT7687_BORA00007421				0

/* Send probe req with BSSID sent during scan */
/*Patch Size:   40 Bytes */
#define MT7687_BORA00007445				1

/*Define two new profiles for Low Power Mode*/
/*Patch Size:   196 Bytes */
...
/*AP + BLE Coex*/
/*Patch Size : 212 Bytes*/
#define MT7687_BORA00007473				0

/*APCLI ALL Channel Scan Support*/
/*patch Size :  912 Bytes*/
#define MT7687_BORA00007469				1

/* AP deauth if receiving Class3 packets from unauthenticated station  */
/* patch size: 32 Bytes */
#define MT7687_BORA00007483				1


/*N9 Assertion Fix while opmode switch due to WPS IE  */
/* patch size: 14 Bytes */
#define MT7687_BORA00007499				1

 /*Country Code Configuration*/
/* patch size: 564 Bytes */
#define MT7687_BORA00007497 						0
