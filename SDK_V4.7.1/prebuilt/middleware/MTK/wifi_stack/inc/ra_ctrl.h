...
#ifdef RA_CTRL
#if 1//def WIFI_BUILD_RAM
#if 1//(CFG_WIFI_DRIVER_OFFLOAD_RATE_CTRL == 1)
//#define MT_MAC
#ifdef DOT11_N_SUPPORT
#undef DOT11_N_SUPPORT
#endif
...
#if 1//(PRODUCT_VERSION == 7615 || PRODUCT_VERSION == 7637 || PRODUCT_VERSION == 7686 || PRODUCT_VERSION == 7682 || PRODUCT_VERSION == 5932)
...
#define MAX_TX_QUALITY_INDEX    3
#else
#define MAX_TX_QUALITY_INDEX    33
#endif
...
#define RTMP_SEM_EVENT_INIT
#define RTMP_SEM_EVENT_DESTORY
#define RTMP_SEM_EVENT_WAIT(_pSema, _status)
#define RTMP_SEM_EVENT_UP

#if 1// defined(NEW_RATE_ADAPT_SUPPORT) || defined(RATE_ADAPT_AGBS_SUPPORT)
#if 0
...
typedef struct _RA_INTERNAL_INFO_T {
    ...
    UINT_8  aucTxQuality[MAX_TX_QUALITY_INDEX + 1];
    //UINT_8  aucPER[MAX_TX_QUALITY_INDEX + 1];
...
typedef struct _RA_COMMON_INFO_T {
    ...
    UCHAR   PhyMode;                        /* wdev->PhyMode	WMODE_CAP_AC */
    UCHAR   MaxTxRate;                      /* RATE_1, RATE_2, RATE_5_5, RATE_11 */
    UCHAR   MinTxRate;                      /* RATE_1, RATE_2, RATE_5_5, RATE_11 */
    UCHAR   TxStream;
    UCHAR   RxStream;
    UCHAR   LatchedChannel;
...
#define RA_AGBS_ENTRY(pTable, idx)          ((idx < pTable[0]?(RA_AGBS_TABLE_ENTRY*)&(pTable[(idx+1)*17]):(RA_AGBS_TABLE_ENTRY*)&(pTable[(1)*17])))
...
/* gl_kal_rom.h */
#define os_move_mem(Destination, Source, Length) NdisMoveMemory(Destination, Source, Length)
#define os_zero_mem(Destination, Length)         NdisZeroMemory(Destination, Length)
#define os_equal_mem(Source1, Source2, Length)   (!memcmp(Source1, Source2, Length))
...
#if 0
#if (CFG_FW_LOG_2_HOST_SUPPORT == 1)
extern UINT_8 g_ucLogMethod;
#define MTWF_LOG(Category, SubCategory, Level, Fmt)     \
            if (g_ucLogMethod == ENUM_EXT_CMD_FW_LOG_2_HOST_CTRL_2_HOST)    \
            {                                                               \
                Category##_##Level##_PRINT(Fmt);                             \
            }
#else
...
extern UINT_16 HwFallbackTable11N1SS[64];
#if 0
extern UINT_16 HwFallbackTable11N2SS[64];
extern UINT_16 HwFallbackTable11N3SS[64];
extern UINT_16 HwFallbackTable11N4SS[64];
#endif
extern UINT_16 HwFallbackTableBGN1SS[64];
#if 0
extern UINT_16 HwFallbackTableBGN2SS[64];
extern UINT_16 HwFallbackTableBGN3SS[64];
extern UINT_16 HwFallbackTableBGN4SS[64];
#endif
...
#if defined(MT7636) || defined(MT7615) || defined(MT7637)
...
#endif /* defined(MT7636) || defined(MT7615) || defined(MT7637) */
#endif /* WIFI_BUILD_RAM */
...
VOID
StaQuickResponeForRateUpExecAGS(
    IN struct _RTMP_ADAPTER *pAd,
    IN ULONG idx
    );
...
#ifdef CONFIG_STA_SUPPORT
VOID
StaQuickResponeForRateUpExecAdapt(
    IN struct _RTMP_ADAPTER *pAd,
    IN ULONG i
    );

VOID
MlmeDynamicTxRateSwitchingAdapt(
    IN struct _RTMP_ADAPTER *pAd,
    IN ULONG i,
    IN ULONG TxSuccess,
    IN ULONG TxRetransmit,
...
#endif
VOID
MlmeDynamicTxRateSwitchingLegacy(
    IN struct _RTMP_ADAPTER *pAd,
    IN ULONG i,
    IN ULONG TxSuccess,
    IN ULONG TxRetransmit,
...
VOID
StaQuickResponeForRateAdaptLegacy(
    IN struct _RTMP_ADAPTER *pAd,
    IN ULONG i
    );
#endif /* CONFIG_STA_SUPPORT */
