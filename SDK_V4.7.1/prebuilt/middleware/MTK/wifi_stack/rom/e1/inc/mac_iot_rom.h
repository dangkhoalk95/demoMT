...
typedef __packed struct _IE_CF_PARAM_SET_T {
    UINT_8      ucId;
    UINT_8      ucLength;
    UINT_8      ucCFPCount;
    UINT_8      ucCFPPeriod;
...
} IE_CF_PARAM_SET_T, *P_IE_CF_PARAM_SET_T;
...
typedef __packed struct _RM_MEASURE_PAUSE_REQ_T {
    UINT_16     u2PauseTime;
    UINT_8      aucSubElements[1];
} RM_MEASURE_PAUSE_REQ_T, *P_RM_MEASURE_PAUSE_REQ_T;
...
typedef __packed struct _IE_INTOLERANT_CHNL_REPORT_T {
    UINT_8              ucId;
    UINT_8              ucLength;
    UINT_8              ucRegulatoryClass;
    UINT_8              aucChannelList[1];
} IE_INTOLERANT_CHNL_REPORT_T, *P_IE_INTOLERANT_CHNL_REPORT_T;
...
/* 7.3.2.60 20/40 BSS Coexistence element */
typedef __packed struct _IE_20_40_COEXIST_T {
    UINT_8              ucId;
    UINT_8              ucLength;
    UINT_8              ucData;
...
typedef __packed struct _WLAN_ACTION_FRAME {
    /* Action MAC header */
    UINT_16     u2FrameCtrl;                /* Frame Control */
    UINT_16     u2DurationID;               /* Duration */
    UINT_8      aucDestAddr[MAC_ADDR_LEN];  /* DA */
...
} WLAN_ACTION_FRAME, *P_WLAN_ACTION_FRAME;
...
typedef __packed struct _ACTION_RM_REPORT_FRAME {
    /* MAC header */
    UINT_16     u2FrameCtrl;                /* Frame Control */
    UINT_16     u2Duration;                 /* Duration */
    UINT_8      aucDestAddr[MAC_ADDR_LEN];  /* DA */
...
} ACTION_RM_REPORT_FRAME, *P_ACTION_RM_REPORT_FRAME;

/* 7.4.7.1a 20/40 BSS Coexistence Management frame format */
typedef __packed struct _ACTION_20_40_COEXIST_FRAME {
    /* MAC header */
    UINT_16     u2FrameCtrl;                /* Frame Control */
    UINT_16     u2Duration;                 /* Duration */
    UINT_8      aucDestAddr[MAC_ADDR_LEN];  /* DA */
...
} ACTION_20_40_COEXIST_FRAME, *P_ACTION_20_40_COEXIST_FRAME;

/* 7.4.10 Notify Channel Width Management frame format */
typedef __packed struct _ACTION_NOTIFY_CHNL_WIDTH_FRAME {
    /* MAC header */
    UINT_16     u2FrameCtrl;                /* Frame Control */
    UINT_16     u2Duration;                 /* Duration */
    UINT_8      aucDestAddr[MAC_ADDR_LEN];  /* DA */
...
typedef __packed struct _ACTION_SET_PCO_PHASE_FRAME {
    /* MAC header */
    UINT_16     u2FrameCtrl;                /* Frame Control */
    UINT_16     u2Duration;                 /* Duration */
    UINT_8      aucDestAddr[MAC_ADDR_LEN];  /* DA */
...
} __KAL_ATTRIB_PACKED__ ACTION_SET_PCO_PHASE_FRAME, *P_ACTION_SET_PCO_PHASE_FRAME;

typedef __packed struct _ACTION_SET_VHT_OPERATING_MODE_FRAME {
    /* MAC header */
    UINT_16     u2FrameCtrl;                /* Frame Control */
    UINT_16     u2Duration;                 /* Duration */
    UINT_8      aucDestAddr[MAC_ADDR_LEN];  /* DA */
...
} __KAL_ATTRIB_PACKED__ ACTION_SET_VHT_OPERATING_MODE_FRAME, *P_ACTION_SET_VHT_OPERATING_MODE_FRAME;
//3 Information Elements from WFA.
typedef __packed struct _IE_WFA_T {
    UINT_8      ucId;
    UINT_8      ucLength;
    UINT_8      aucOui[3];
    UINT_8      ucOuiType;
...
typedef __packed struct _IE_WFD_T {
...
typedef __packed struct _WFD_ATTRIBUTE_T {
...
/* WFD 1.10 5.1.2 */
typedef __packed struct _WFD_ATTRI_WFD_DEV_INFO_T {
    UINT_8     ucId;                   /* Subelement ID */
    UINT_16    u2Length;               /* Length */
    UINT_16    u2DevInfo;
    UINT_16    u2ControlPort;
    UINT_16    u2MaximumTp;
}__KAL_ATTRIB_PACKED__ WFD_ATTRI_WFD_DEV_INFO_T, *P_WFD_ATTRI_WFD_DEV_INFO_T;

/* WFD 1.10 5.1.3 */
typedef __packed struct _WFD_ATTRI_ASSOCIATED_BSSID_T {
    UINT_8     ucId;                   /* Subelement ID */
    UINT_16    u2Length;               /* Length */
    UINT_8     aucAssociatedBssid[MAC_ADDR_LEN];
}__KAL_ATTRIB_PACKED__ WFD_ATTRI_ASSOCIATED_BSSID_T, *P_WFD_ATTRI_ASSOCIATED_BSSID_T;

/* WFD 1.10 5.1.4 */
typedef __packed struct _WFD_ATTRI_COUPLED_SINK_STATUS_T {
    UINT_8     ucId;                   /* Subelement ID */
    UINT_16    u2Length;               /* Length */
    UINT_8     ucCoupledSinkStatus;
    UINT_8     aucCoupledSinkAddress[MAC_ADDR_LEN];
}__KAL_ATTRIB_PACKED__ WFD_ATTRI_COUPLED_SINK_STATUS_T, *P_WFD_ATTRI_COUPLED_SINK_STATUS_T;

typedef __packed  struct _WFD_ATTRI_EXT_CAPA_BITMAPT {
    UINT_8     ucId;                   /* Subelement ID */
    UINT_16    u2Length;               /* Length */
    UINT_16    u2ExtCapaBitMap;
} __KAL_ATTRIB_PACKED__ WFD_ATTRI_EXT_CAPA_BITMAP_T, *P_WFD_ATTRI_EXT_CAPA_BITMAP_T;

/* WFD 1.10 5.1.14 */
typedef __packed struct _WFD_DEV_INFO_DESC_T {
    ...
    UINT_8     ucCoupledSinkStatus;
    UINT_8     aucCoupledSinkAddress[MAC_ADDR_LEN];
}__KAL_ATTRIB_PACKED__  WFD_DEV_INFO_DESC_T, *P_WFD_DEV_INFO_DESC_T;


typedef __packed struct _WFD_ATTRI_WFD_SESSION_INFO_T {
    UINT_8     ucId;                   /* Subelement ID */
    UINT_16      u2Length;               /* Length */
    WFD_DEV_INFO_DESC_T  arWfdDevDesc[1];
}__KAL_ATTRIB_PACKED__  WFD_ATTRI_WFD_SESSION_INFO_T, *P_WFD_ATTRI_WFD_SESSION_INFO_T;
