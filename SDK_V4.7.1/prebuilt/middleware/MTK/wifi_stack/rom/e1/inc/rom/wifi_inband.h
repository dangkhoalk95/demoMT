...
*/
int32_t wifi_inband_bssid(uint8_t flag_set, uint8_t *bssid, uint8_t channel, uint8_t wps_enable);
...
* @return 0 means success, > 0 means fail
*/
int32_t wifi_inband_set_ip_mac_port_list_entry(uint8_t action,ip_match_entry_t *entry_list);
