 ...
 *     For more information about the SDP record, please refer to \ref BluetoothSPP. Then call #bt_notify_init() with the SDP ID to initialize the Bluetooth notification service.
 *   - Sample code:
 *     @code
