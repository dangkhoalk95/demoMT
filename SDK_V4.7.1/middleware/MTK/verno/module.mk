...
LDFLAGS += -u build_date_time_str -u sw_verno_str -u hw_verno_str -u md_commit_id_str
...
$(BUILD_DIR)/middleware/MTK/verno/verno.c: FORCE
	@mkdir -p $(dir $@)
	@$(SOURCE_DIR)/middleware/MTK/verno/gen_verno.sh $(SOURCE_DIR)/middleware/MTK/verno/verno.template $@ $(MTK_FW_VERSION) $(BOARD_CONFIG) $(SOURCE_DIR)
