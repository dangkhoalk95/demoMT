...
#define MP3_CODEC_MEDIA_OK                  (0)
#define MP3_CODEC_MEDIA_REQUEST             (1)
#define MP3_CODEC_MEDIA_UNDERFLOW           (2)
#define MP3_CODEC_MEDIA_JUMP_FILE_TO        (3)
#endif
...
typedef struct {
    ...
    int32_t (*get_data_count)(bt_sink_srv_am_id_t aud_id);                                          /**< Get the available length from the shared buffer. */
...
/**
 * @brief                   This function is employed to check music mode and close old music.
 * @param[in] mode          Specified music mode
 * @return
 */
...
/**
 * @brief                   This function is employed to switch music mode.
 * @return
 */
int32_t bt_sink_srv_ami_switch_music_mode(void);

/**
 * @brief                   This function is employed to get new music mode after switch.
 * @return
 */
