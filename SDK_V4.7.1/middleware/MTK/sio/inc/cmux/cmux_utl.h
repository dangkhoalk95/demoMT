...
#ifndef __CMUX_UTILITY_H__
#define __CMUX_UTILITY_H__
...
extern void cmux_notifyDlcConnectInd(CmuxDlcT *pDlc);
extern void cmux_notifyCPortPlugout(CmuxDlcT *pDlc);

extern void cmux_writeToUart(kal_uint8 *pPdu, kal_uint16 u2ToWrite);
extern void cmux_sendPnMessage(kal_uint32 dlci);
extern void cmux_sendCldMessage(kal_bool command_cr);
extern void cmux_handleControlMessage(void);
