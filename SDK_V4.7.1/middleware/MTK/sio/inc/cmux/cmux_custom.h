...
#ifndef __CMUX_CUSTOM_H__
#define __CMUX_CUSTOM_H__

#include "cmux_porting.h"

extern kal_uint8 cmux_getDlcType(kal_uint8 channel);
...
extern kal_uint8 cmux_custom_getChannelIndex(kal_uint8 dlci);

#endif /* __CMUX_CUSTOM_H__ */
