...
static int16_t bt_sink_srv_cmd_entry(const char *string)
{
    ...
    if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("INQ"))) {
        ...
        bt_sink_srv_action_send(BT_SINK_SRV_ACTION_CALL_VOLUME_UP, NULL);
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("CALLVDN"))) { // CALL VOLUME DOWN
        bt_sink_srv_action_send(BT_SINK_SRV_ACTION_CALL_VOLUME_DOWN, NULL);
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("CALLVMIN"))) { // CALL VOLUME MIN
        bt_sink_srv_action_send(BT_SINK_SRV_ACTION_CALL_VOLUME_MIN, NULL);
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("CALLVMAX"))) { //CALL VOLUME MAX
        bt_sink_srv_action_send(BT_SINK_SRV_ACTION_CALL_VOLUME_MAX, NULL);
        ...
        bt_sink_srv_memcpy(&request.address, address_p, sizeof(bt_bd_addr_t));
        ...
        bt_sink_srv_action_send(BT_SINK_SRV_ACTION_NEXT_TRACK, NULL);
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("PREV"))) { //BT MUSIC RREV
        bt_sink_srv_action_send(BT_SINK_SRV_ACTION_PRE_TRACK, NULL);
        ...
        bt_sink_srv_action_send(BT_SINK_SRV_ACTION_PAUSE, NULL);
    ...
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("POWEROFF"))) { //Power off
        bt_sink_srv_action_send(BT_SINK_SRV_ACTION_POWER_OFF, NULL);
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("PSTH"))) {
        bt_sink_srv_action_send(BT_SINK_SRV_ACTION_SWITCH_PASS_THROUGH_MODE, NULL);
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("MP3FRAME"))) {
        bt_sink_srv_mp3_change_frame_log();
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("MODE-BT"))) {
        #ifdef __BT_SINK_SRV_MUSIC_MODE_SUPPORT__
        extern int32_t bt_sink_srv_set_music_mode(bt_sink_srv_music_mode_t mode);
        bt_sink_srv_set_music_mode(BT_SINK_SRV_MODE_BT_MUSIC);
        #endif
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("MODE-LOCAL"))) {
        #ifdef __BT_SINK_SRV_MUSIC_MODE_SUPPORT__
        extern int32_t bt_sink_srv_set_music_mode(bt_sink_srv_music_mode_t mode);
        bt_sink_srv_set_music_mode(BT_SINK_SRV_MODE_LOCAL_MUSIC);
        #endif
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("Aud-play"))) {
        #if defined(MTK_AUDIO_MP3_ENABLED)
        extern int32_t bt_sink_srv_mp3_play();
        bt_sink_srv_mp3_play();
        #endif
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("Aud-pause"))) {
        #if defined(MTK_AUDIO_MP3_ENABLED)
        extern int32_t bt_sink_srv_mp3_pause();
        bt_sink_srv_mp3_pause();
        #endif
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("Aud-next"))) {
        #if defined(MTK_AUDIO_MP3_ENABLED)
        extern int32_t bt_sink_srv_mp3_next_track();
        bt_sink_srv_mp3_next_track();
        #endif
    } else if (0 == bt_sink_srv_memcmp(string, CMD_PARAM("Aud-prev"))) {
        #if defined(MTK_AUDIO_MP3_ENABLED)
        extern int32_t bt_sink_srv_mp3_prev_track();
