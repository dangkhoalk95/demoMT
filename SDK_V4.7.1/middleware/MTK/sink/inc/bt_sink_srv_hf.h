...
#endif
#define BT_SINK_SRV_HF_INVALID_AUDIO_ID  AUD_ID_INVALID
...
typedef enum {
    BT_SINK_SRV_HF_AUDIO_NONE = 0x00,
    BT_SINK_SRV_HF_AUDIO_NULL= 0x01,
    BT_SINK_SRV_HF_AUDIO_SCO = 0x02,
    BT_SINK_SRV_HF_AUDIO_RING = 0x03,
    BT_SINK_SRV_HF_AUDIO_TOTAL = 0x04
...
typedef enum {
    ...
    BT_SINK_SRV_HF_FLAG_DESTROY_CONTEXT = 0x0020
} bt_sink_srv_hf_flag_t;

typedef enum {
    BT_SINK_SRV_HF_DEV_STATE_NONE = 0,
    BT_SINK_SRV_HF_DEV_STATE_READY,
    BT_SINK_SRV_HF_DEV_STATE_PLAYING
} bt_sink_srv_hf_dev_state;

typedef enum {
    BT_SINK_SRV_HF_DEV_SUB_STATE_NONE = 0,
    BT_SINK_SRV_HF_DEV_SUB_STATE_CONNECTING,
    BT_SINK_SRV_HF_DEV_SUB_STATE_DISCONNECTING,
    BT_SINK_SRV_HF_DEV_SUB_STATE_PREPARE_PLAY,
    BT_SINK_SRV_HF_DEV_SUB_STATE_PREPARE_STOP
} bt_sink_srv_hf_dev_sub_state;

typedef struct {
    uint32_t handle;
    bt_sink_srv_hf_audio_type_t audio_type;
...
typedef struct {
    ...
    bt_sink_srv_hf_dev_state dev_state;
    bt_sink_srv_hf_dev_sub_state dev_sub_state;
