 ...
 *           if (status != BT_CODEC_MEDIA_STATUS_MEDIA_OK) {
 ...
 * @return    #BT_CODEC_MEDIA_STATUS_MEDIA_OK, if the operation completed successfully.
 ...
 * @return    #BT_CODEC_MEDIA_STATUS_MEDIA_OK, if if the operation completed successfully.
 ...
 * @return    If the operation completed successfully, the return value is #BT_CODEC_MEDIA_STATUS_MEDIA_OK, otherwise the return value is #BT_CODEC_MEDIA_STATUS_MEDIA_ERROR.
 */
