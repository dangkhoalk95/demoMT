...
typedef struct {
    ...
    uint8_t freq_h;             /**< The first part of frequency, b0: 44.1K, b1: 32K, b2: 24K, b3: 22.05K, b4: 16K, b5: 12K, b6: 11.025K, b7: 8K. */
    uint8_t reserved:2;         /**< Pad bit (b0, b1): reserved. */
    uint8_t channels:2;         /**< The channels (b2,b3), b2: 2, b3: 1. */
    uint8_t freq_l:4;           /**< The last part of frequency (b4~b7), b4: 96K, b5: 88.2K, b6: 64K, b7: 48K. */
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_CONNECT_IND event.
 */
typedef struct {
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_CONNECT_CNF event.
 */
typedef struct {
    uint32_t handle;           /**< A2DP handle. */
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_DISCONNECT_IND event.
 */
typedef struct {
    uint32_t handle;           /**< A2DP handle. */
...
/**
 *  @brief his structure defines the data type of the parameter in the callback for #BT_A2DP_DISCONNECT_CNF event.
 */
typedef struct {
    uint32_t handle;           /**< A2DP handle. */
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_START_STREAMING_IND event.
 */
typedef struct {
    uint32_t handle;                             /**< A2DP handle. */
    bt_a2dp_codec_capability_t *codec_cap;       /**< Streaming channel codec capability. */
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_START_STREAMING_CNF event.
 */
typedef struct {
    uint32_t handle;                            /**< A2DP handle. */
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_SUSPEND_STREAMING_IND event.
 */
typedef struct {
    uint32_t handle;                           /**< A2DP handle. */
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_SUSPEND_STREAMING_CNF event.
 */
typedef struct {
    uint32_t handle;                            /**< A2DP handle. */
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_RECONFIGURE_IND event.
 */
typedef struct {
    uint32_t handle;                             /**< A2DP handle. */
    bt_a2dp_codec_capability_t *codec_cap;       /**< Streaming channel codec capability. */
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_RECONFIGURE_CNF event.
 */
typedef struct {
    uint32_t handle;                            /**< A2DP handle. */
...
/**
 *  @brief This structure defines the data type of the parameter in the callback for #BT_A2DP_STREAMING_RECEIVED_IND event.
 */
typedef struct {
    uint32_t handle;                             /**< A2DP handle. */
...
/**
 * @brief               This function reconfigures the already configured stream and api needs to be called only in stream open state not in streaming state
 *				. The #BT_A2DP_RECONFIGURE_CNF event will be sent to the upper layer with reconfigure stream result.
 * @param[in] handle    is the connection handle of the specified remote device.
 * @param[in] codec_cap    is the codec capabilities that need to be renegotiated with the remote device.
 * @return              #BT_STATUS_SUCCESS, the operation completed successfully.
 *                      #BT_STATUS_FAIL, the operation has failed.
 *                      #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
 ...
 * @param[in] timestamp    is the timestamp value that need to be added in the media header.
 * @return              #BT_STATUS_SUCCESS, the operation completed successfully.
 *                      #BT_STATUS_FAIL, the operation has failed.
 *                      #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
...
/**
 * @brief               This function return the maximum A2dp payload data vale in bytes so that app can send data lower this value
 * @param[in] handle    is the connection handle of the specified remote device.
