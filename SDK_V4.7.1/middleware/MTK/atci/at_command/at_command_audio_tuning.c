...
void call_this_funtion_if_eaps_data_is_changed(void *data)
{
    ...
    if (eaps == NULL) {
        LOGI("eaps allocate fail, just return\r\n");
        return;
    }
            ...
            switch (AT_command_array[1]) {
                ...
                case ATTTEST_DEVICE_MODE_VOICE_NB_MODE_3:
                    ...
                    if (AT_command_array[1] == ATTTEST_DEVICE_MODE_VOICE_NB_MODE_1) {
                        LOGI("atttest: stream_out:HAL_AUDIO_DEVICE_HEADSET_MONO, stream_in:HAL_AUDIO_DEVICE_HEADSET_MIC, NB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                        ...
                        LOGI("atttest: stream_out:HAL_AUDIO_DEVICE_HANDS_FREE_MONO, stream_in:HAL_AUDIO_DEVICE_MAIN_MIC, NB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                        ...
                        LOGI("atttest: stream_out:HAL_AUDIO_DEVICE_HEADSET_MONO, stream_in:HAL_AUDIO_DEVICE_DUAL_DIGITAL_MIC, NB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                ...
                case ATTTEST_DEVICE_MODE_VOICE_WB_MODE_3:
                    ...
                    if (AT_command_array[1] == ATTTEST_DEVICE_MODE_VOICE_WB_MODE_1) {
                        LOGI("atttest: stream_out:HAL_AUDIO_DEVICE_HEADSET_MONO, stream_in:HAL_AUDIO_DEVICE_HEADSET_MIC, WB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                        ...
                        LOGI("atttest: stream_out:HAL_AUDIO_DEVICE_HANDS_FREE_MONO, stream_in:HAL_AUDIO_DEVICE_MAIN_MIC, WB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                        ...
                        LOGI("atttest: stream_out:HAL_AUDIO_DEVICE_HEADSET_MONO, stream_in:HAL_AUDIO_DEVICE_DUAL_DIGITAL_MIC, WB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
...
static attdet_error_check_t query_useful_information_for_ui_tool(uint32_t *out_data_buffer, int16_t *out_data_buffer_size, uint32_t at_command_array[], int16_t at_command_array_size)
{
    ...
    switch (at_command_array[3]) {
        ...
        case ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HEADSET:
            ...
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HEADSET\n");
        ...
        case ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HANDSFREE:
            ...
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HANDSFREE\n");
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HEADSET:
            ...
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HEADSET\n");
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HANDSFREE:
            ...
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HANDSFREE\n");
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_RESERVED:    // stream_out: headset; stream_in: dual mic
            ...
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_RESERVED\n");
        ...
        case ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_NORMAL: // headset mic
            ...
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_NORMAL\n");
        ...
        case ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_ASR:    // A-mic
            ...
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_ASR\n");
        ...
        case ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_STEREO: // dual mic
            ...
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_STEREO\n");
        ...
        case ATTDET_PARAMETER_INDEX_AUDIO_IIR_FILTER_INFORMATION:
            ...
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_AUDIO_IIR_FILTER_INFORMATION\n");
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_NB_MODE_AND_FIR_PARAMETER_INFORMATION:
            ...
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_NB_MODE_AND_FIR_PARAMETER_INFORMATION\n");
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_WB_MODE_AND_FIR_PARAMETER_INFORMATION:
            ...
            // input FIR coefficient array size, input FIR coefficient value range(Amount of bits), Amount of frquency, Amount of response,
            // output FIR coefficient array size, output FIR coefficient value range(Amount of bits), Amount of frquency, Amount of response,"
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_WB_MODE_AND_FIR_PARAMETER_INFORMATION\n");
        ...
        case ATTDET_PARAMETER_INDEX_RECORD_WB_MODE_AND_FIR_PARAMETERS_INFORMATION:
            ...
            LOGI("parameter index: ATTDET_PARAMETER_INDEX_RECORD_WB_MODE_AND_FIR_PARAMETERS_INFORMATION\n");
