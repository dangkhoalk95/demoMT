...
public:
    ...
    /**
     * @fn void AnalogClock::setBackground(const BitmapId backgroundBitmapId);
     *
    ...
    /**
     * @fn void AnalogClock::setBackground(const BitmapId backgroundBitmapId, int16_t rotationCenterX, int16_t rotationCenterY);
     *
    ...
    /**
     * @fn void AnalogClock::setupHourHand(const BitmapId hourHandBitmapId, int16_t rotationCenterX, int16_t rotationCenterY);
     *
    ...
    /**
     * @fn void AnalogClock::setupMinuteHand(const BitmapId minuteHandBitmapId, int16_t rotationCenterX, int16_t rotationCenterY);
     *
    ...
    /**
     * @fn void AnalogClock::setupSecondHand(const BitmapId secondHandBitmapId, int16_t rotationCenterX, int16_t rotationCenterY);
     *
    ...
    /**
     * @fn void AnalogClock::setHourHandMinuteCorrection(bool active);
     *
     ...
     */
    void setHourHandMinuteCorrection(bool active);

    /**
     * @fn bool AnalogClock::getHourHandMinuteCorrection() const;
     *
    ...
    /**
     * @fn void AnalogClock::setMinuteHandSecondCorrection(bool active);
     *
     ...
     */
    void setMinuteHandSecondCorrection(bool active);

    /**
     * @fn bool AnalogClock::getMinuteHandSecondCorrection();
     *
    ...
    /**
     * @fn void AnalogClock::setAnimation(uint16_t duration = 10, EasingEquation animationProgressionEquation = EasingEquations::backEaseInOut);
     *
     ...
     */
    void setAnimation(uint16_t duration = 10, EasingEquation animationProgressionEquation = EasingEquations::backEaseInOut);

    /**
     * @fn uint16_t AnalogClock::getAnimationDuration()
     *
    ...
    /**
     * @fn void AnalogClock::initializeTime24Hour(uint8_t hour, uint8_t minute, uint8_t second);
     *
     ...
     */
    void initializeTime24Hour(uint8_t hour, uint8_t minute, uint8_t second);

    /**
     * @fn void AnalogClock::initializeTime12Hour(uint8_t hour, uint8_t minute, uint8_t second, bool am);
     *
     ...
     */
    void initializeTime12Hour(uint8_t hour, uint8_t minute, uint8_t second, bool am);
...
protected:
    ...
    /**
     * @fn void AnalogClock::setupHand(TextureMapper& hand, const BitmapId bitmapId, int16_t rotationCenterX, int16_t rotationCenterY);
     *
    ...
    /**
     * @fn float AnalogClock::convertHandValueToAngle(uint8_t steps, uint8_t handValue, uint8_t secondHandValue = 0) const;
     *
     ...
     */
    float convertHandValueToAngle(uint8_t steps, uint8_t handValue, uint8_t secondHandValue = 0) const;

    /**
     * @fn bool AnalogClock::animationEnabled();
     *
