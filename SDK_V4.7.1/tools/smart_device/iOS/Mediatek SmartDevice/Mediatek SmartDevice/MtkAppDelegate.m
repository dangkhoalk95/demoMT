...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    NSLog(@"[applicationDidEnterBackground] enter");
    
    [[NSNotificationCenter defaultCenter] postNotificationName: kEnterBackgroundNotification object: nil];
    
    [[BackgroundManager sharedInstance] setAppBackgroundOrForeground:YES];
}

- (void)applicationWillEnterForeground:(UIApplication *)application
{
    // Called as part of the transition from the background to the inactive state; here you can undo many of the changes made on entering the background.
    NSLog(@"[applicationWillEnterForeground] enter， current Version 1.1.5");
    
    [[NSNotificationCenter defaultCenter] postNotificationName: kEnterForegroundNotification object: nil];
    
    [[BackgroundManager sharedInstance] setAppBackgroundOrForeground:NO];
}
...
- (void)applicationWillTerminate:(UIApplication *)application
{
    ...
    [[NSUserDefaults standardUserDefaults] setBool: YES forKey: UserDefaultKey_killedForcely];
}
