...
@par Hardware and software environment
  ...
  - Customization Option
      - \b MTK_MINICLI_ENABLE: This definition determines whether the demo
        suppots the Command Line Interface (CLI). If it is not defined, then
        the demo cannot use the CLIs.
      - \b MTK_SMTCN_ENABLE: This definition determines whether the demo
        suppots the WiFi Smart Connection feature. If it is not defined, then
        the demo cannot use the WiFi Smart Connection feature.
      - \b MTK_WIFI_WPS_ENABLE: This definition determines whether the demo
        suppots the WPS feature. If it is not defined, then
        the demo cannot use the WPS feature.
      - \b MTK_WIFI_REPEATER_ENABLE: This definition determines whether the demo
        suppots the Wi-Fi repeater mode feature. If it is not defined, then
        the demo cannot use the function of repeater mode.
      - \b MTK_DEBUG_LEVEL = info: This definition determines the debug level.
        Such as: none, error, warning, and info.
