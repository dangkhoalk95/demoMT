 ...
 * @{
 * @addtogroup mt7697_hdk_hal_examples_i2c_control_EEPROM_with_polling i2c_control_EEPROM_with_polling
 * @{
...
@par Hardware and software environment
  ...
  - Note:
    - The pull-up resistors are needed for the I2C interface to provide the
      ...
      7697 HDK, the two pull-up resistors R1003 and R1002 are already
...
@par Run the example
  - Build the example project with a command "./build.sh mt7697_hdk
    ...
    the binary file to the LinkIt 7697 HDK.
